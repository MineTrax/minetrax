      ...
      <div class="flex justify-between mb-8">
        ...
        <div class="flex">
          <inertia-link
            ...
            class="mr-1 inline-flex items-center px-4 py-2 bg-primary border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-primary active:bg-primary focus:outline-none focus:border-primary focus:shadow-outline-gray transition ease-in-out duration-150"
          >
      ...
      <div class="flex flex-col md:flex-row md:space-x-4">
        <div class="flex flex-col space-y-4  md:w-8/12 bg-white p-4 rounded dark:bg-surface-800 text-foreground dark:text-foreground">
          ...
          <div
            ...
            :key="999999999"
            class="flex items-center justify-center italic text-foreground dark:text-foreground"
          >
