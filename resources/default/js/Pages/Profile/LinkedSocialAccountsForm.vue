...
<template>
 <div>
 <h3 class="text-lg font-medium text-foreground dark:text-foreground">
 {{ __("Social Accounts") }}
 </h3>
 ...
 <div v-else class="mt-3 max-w-xl text-sm text-foreground dark:text-foreground">
 <ul v-if="socialAccounts.length"class="space-y-4">
 <li v-for="account in socialAccounts":key="account.id">
 <div class="flex space-x-2 items-center">
 <Icon class="h-8 w-8 fill-current":name="account.provider"/>
 ...
 <XMarkIcon class="h-5 w-5 text-foreground rounded hover:bg-destructive/80 hover:text-white"/>
 </LoadingButton>
 </JetConfirmsPassword>
 </div>
 </li>
