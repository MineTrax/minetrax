            ...
            <div v-for="(session, i) in sessions" :key="i" class="flex items-center">
                <div>
                    <svg v-if="session.agent.is_desktop" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" class="w-8 h-8 text-foreground">
                        <path
                ...
                <div class="ml-3">
                    ...
                    <div>
                        <div class="text-xs text-foreground">
                            ...
                            <span v-if="session.is_current_device" class="text-success-500 font-semibold">{{ __("This device")
                            }}</span>
            ...
            <template #content>
                ...
                <div class="mt-4">
                    <jet-input ref="password" v-model="form.password" type="password" class="mt-1 block w-3/4"
                        :placeholder="__('Password')" @keyup.enter.native="logoutOtherBrowserSessions" />
