...
<template>
 ...
 <p class="font-semibold">{{ __("Setup Key") }}: <span v-html="setupKey"/></p>
 </div>
 ...
 <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-muted dark:bg-background dark:text-foreground rounded-lg">
 ...
 <JetButton v-if="confirming"type="button"class="mr-3":class="{'opacity-25': enabling }":disabled="enabling">
 {{ __("Confirm") }}
 </JetButton>
 </JetConfirmsPassword>
