        ...
        <div class="py-4 px-2 md:px-10 max-w-screen-2xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:space-x-4">
                <div class="flex flex-col space-y-6 md:w-9/12">
                        ...
                        <div v-for="(news, index) in newsList.data" :key="index" class="space-y-6">
                            <Card class="group relative overflow-hidden transition-shadow duration-300 hover:shadow-lg">
                                <CardContent class="p-6 sm:p-8">
                                    ...
                                    <!-- Title section -->
                                    <div class="mb-4">
                                        <Link :href="route('news.show', news.slug)" class="group/title" prefetch>
                                        <h2
                                            class="text-2xl sm:text-3xl font-bold leading-tight text-card-foreground group-hover/title:text-primary transition-colors duration-200 mb-2">
                                            {{ news.title }}
                                        </h2>
                                        </Link>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between mb-4 pb-4 border-b border-border/30">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <div class="flex items-center space-x-2">
                                                <img :src="news.creator.profile_photo_url" alt="Profile"
                                                    class="h-8 w-8 rounded-full border border-border/20">
                                                <div class="text-sm">
                                                    <Link :href="route('user.public.get', news.creator.username)"
                                            ...
                                            <div class="text-sm text-muted-foreground">
                                                <span v-tippy :content="formatTimeAgoToNow(news.created_at)"
                                                    class="cursor-help">
                    ...
                    <div v-if="newsList.data <= 0" class="py-2 align-middle inline-block min-w-full">
