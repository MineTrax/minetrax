...
<template>
 ...
 <button class="cursor-pointer ml-6 text-sm text-destructive"@click="confirmApiTokenDeletion(token)">
 Delete
 </button>
 </div>
 </div>
 ...
 <div v-if="$page.props.jetstream.flash.token"class="mt-4 bg-muted px-4 py-2 rounded font-mono text-sm text-foreground">
