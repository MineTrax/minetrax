<template>
 <AppLayout>
 <div id="container"class="m-10 border-2 border-destructive">
 Hello World
 ...
 <a class="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-hidden focus:shadow-md"
 href="/">
 ...
 <NavigationMenuItem>
 <NavigationMenuTrigger>Getting Started 2</NavigationMenuTrigger>
 <NavigationMenuContent>
 <ul
 class="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[minmax(0,.75fr)_minmax(0,1fr)]">
 <li class="row-span-3">
