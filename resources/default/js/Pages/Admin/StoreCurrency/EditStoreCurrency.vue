...
const breadcrumbItems = [
    ...
    {
        text: __("Edit Currency"),
        current: false,
    },
    {
        text: props.currency.code,
        current: true,
    }
];
...
const selectedCountries = props.countries.filter(country =>
    props.currency.country_codes?.includes(country.iso_code)
).map(country => ({
    id: country.iso_code,
    name: country.name,
}));
...
<template>
  <AdminLayout>
    <app-head :title="__('Edit Currency')" />
              ...
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  <XInput
                    ...
                    :help="currency.is_base ? __('The base currency rate is fixed at 1.') : __('How many of this currency equal one unit of the base currency.')"
                ...
                <div class="flex items-center col-span-6 sm:col-span-3">
                  <XSwitch
                    ...
                    :label="__('Enabled')"
                    :help="currency.is_base ? __('The base currency is always enabled.') : __('Enable this currency for use.')"
                    name="is_enabled"
