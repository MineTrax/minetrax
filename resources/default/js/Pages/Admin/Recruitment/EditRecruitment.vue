<template>
  <AdminLayout>
    <app-head title="Edit Application Form" />
            ...
            <form @submit.prevent="updateRecruitment">
              <div class="shadow overflow-hidden sm:rounded-md">
                <div class="px-4 py-5 bg-white dark:bg-surface-800 sm:p-6">
                  <div class="grid grid-cols-6 gap-4">
                    ...
                    <div class="flex-col col-span-6 space-y-1 sm:col-span-6">
                      <legend class="text-base font-medium text-secondary-900 dark:text-secondary-300">
                        {{ __("Fields") }}
                      </legend>
                      ...
                      <div class="w-full space-y-1">
                        <div class="flex space-x-4">
                          ...
                          >{{
                            ...
                            <span class="text-xs text-secondary-500">(Eg:
                          ...
                          <template #item="{ element: field, index }">
                            <div class="flex space-x-4 items-start">
                              ...
                              <div class="flex-1">
                                ...
                                <div
                                  v-else
                                  class="h-full text-secondary-700 text-lg font-semibold dark:text-secondary-300 w-full flex items-center justify-center"
                                >
                                  -
                                </div>
                              </div>
                        ...
                        <div class="flex justify-end mt-1">
                          <button
                            type="button"
                            class="p-1.5 text-xs text-primary-500 rounded border border-primary-500 focus:outline-none hover:text-primary-300 hover:border-primary-300 transition ease-in-out duration-150"
                            @click="addField"
                          >
                            {{
                              __("Add New Field")
                ...
                <div class="px-4 py-3 bg-surface-50 dark:bg-surface-800 sm:px-6 flex justify-between gap-2">
                  <loading-button
                    class="inline-flex justify-center py-2 px-4 border border-secondary-200 shadow-sm text-sm font-medium rounded-md text-secondary-600 bg-surface-50 hover:bg-white disabled:opacity-50 dark:bg-surface-700 dark:border-secondary-700 dark:text-secondary-300 dark:hover:bg-surface-600 dark:hover:border-secondary-600"
                    type="button"
