                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                      <div class="px-4 py-5 bg-white dark:bg-surface-800 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                          ...
                          >
                            <legend class="text-sm text-secondary-700 font-bold dark:font-semibold dark:text-secondary-300">
                              {{ __("Account Link Success Commands") }}
                              <span class="text-xs font-light text-secondary-400">{{ __("(runs when a player is linked to account)") }}</span>
                            </legend>
                            ...
                            <div class="w-full space-y-2">
                              <div class="flex flex-col items-end">
                                ...
                                <ol class="text-sm text-right text-secondary-600 dark:text-secondary-400">
                                  <li>
                                    <code class="text-sm bg-surface-100 dark:bg-surface-700 dark:text-secondary-300 p-1 rounded-md">{PLAYER_USERNAME}</code> - {{ __("Username of the player which is linked.") }}
                                  </li>
                                  <li>
                                    <code class="text-sm bg-surface-100 dark:bg-surface-700 dark:text-secondary-300 p-1 rounded-md">{PLAYER_UUID}</code> - {{ __("Unique Id of the player which is linked.") }}
                                  </li>
                                </ol>
                              </div>
                                  ...
                                  <div class="grid grid-cols-2 gap-2 w-full">
                                    <div class="flex-1">
                                      <input
                                        ...
                                        class="block p-2.5 dark:bg-surface-900 dark:text-secondary-300 w-full dark:border-secondary-700 border-secondary-200 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                              ...
                              <div
                                ...
                                class="text-secondary-500 text-sm italic text-center pt-2"
                              >
                              ...
                              <div class="flex justify-center pt-5">
                                <button
                                  type="button"
                                  class="p-2 w-1/3 text-sm text-primary-500 rounded border border-primary-500 focus:outline-none hover:text-primary-300 hover:border-primary-300 transition ease-in-out duration-150"
                          ...
                          >
                            <legend class="text-sm text-secondary-700 font-bold dark:font-semibold dark:text-secondary-300">
                              ...
                              <span class="text-xs font-light text-secondary-400">{{ __("(runs when a player is unlinked from account)") }}</span>
                            </legend>
                            ...
                            <div class="w-full space-y-2">
                              <div class="flex flex-col items-end">
                                ...
                                <ol class="text-sm text-right text-secondary-600 dark:text-secondary-400">
                                  <li>
                                    <code class="text-sm bg-surface-100 dark:bg-surface-700 dark:text-secondary-300 p-1 rounded-md">{PLAYER_USERNAME}</code> - {{ __("Username of the player which is unlinked.") }}
                                  </li>
                                  <li>
                                    <code class="text-sm bg-surface-100 dark:bg-surface-700 dark:text-secondary-300 p-1 rounded-md">{PLAYER_UUID}</code> - {{ __("Unique Id of the player which is unlinked.") }}
                                  </li>
                                </ol>
                              </div>
                          ...
                          >
                            <legend class="text-sm text-secondary-700 font-bold dark:font-semibold dark:text-secondary-300">
                              ...
                              <span class="text-xs font-light text-secondary-400">{{ __("(run when user try to reset his linked player password)") }}</span>
                            </legend>
                            ...
                            <div class="w-full space-y-2">
                              <div class="flex flex-col items-end">
                                ...
                                <ol class="text-sm text-right text-secondary-600 dark:text-secondary-400">
                                  <li>
                                    <code class="text-sm bg-surface-100 dark:bg-surface-700 dark:text-secondary-300 p-1 rounded-md">{PLAYER_USERNAME}</code> - {{ __("Username of the player whose password is being reset.") }}
                                  </li>
                                  <li>
                                    <code class="text-sm bg-surface-100 dark:bg-surface-700 dark:text-secondary-300 p-1 rounded-md">{PLAYER_UUID}</code> - {{ __("Unique Id of the player whose password is being reset.") }}
                                  </li>
                                  <li>
                                    <code class="text-sm bg-surface-100 dark:bg-surface-700 dark:text-secondary-300 p-1 rounded-md">{PASSWORD}</code> - {{ __("New validated password entered by user.") }}
                                  </li>
                                </ol>
                              </div>
