                    ...
                    <div class="space-y-6">
                      ...
                      >
                        ...
                        <div class="text-foreground">
                          <button
                            type="button"
                            class="-mt-3 text-xs float-right text-primary focus:outline-hidden underline hover:text-primary"
                        ...
                        <div class="flex flex-col text-sm w-3/5 p-4 border-2 border-border rounded bg-muted/30">
                          ...
                          <p
                            ...
                            class="p-2 mt-1 text-center bg-success font-semibold rounded text-white"
                          >
