        ...
        return {
            form: useForm({
                ...
                settings: {
                    ...
                    is_skin_change_via_web_allowed: this.server?.settings?.is_skin_change_via_web_allowed ?? false,
                    is_banwarden_enabled: this.server?.settings?.is_banwarden_enabled ?? false,
                },
