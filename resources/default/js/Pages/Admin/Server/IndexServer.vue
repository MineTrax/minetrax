          ...
          <td class="px-4 space-y-1 whitespace-nowrap">
            <div class="flex">
              <span
                ...
                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-muted dark:bg-muted text-foreground dark:text-foreground"
              >{{ __("Loading") }}...</span>
              <span
              ...
              <span
                ...
                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-destructive/10 text-destructive"
              >
                {{ __("Server") }}
                🔴
              </span>
