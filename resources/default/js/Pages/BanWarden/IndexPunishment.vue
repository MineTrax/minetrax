  ...
  <AppLayout>
    ...
    <div class="py-4 px-2 md:py-12 md:px-10 max-w-screen-2xl mx-auto">
      <div class="grid-cols-5 gap-4 mb-4 hidden md:grid">
        ...
        <div class="col-span-full  md:col-span-1">
          <div class="flex flex-row bg-white dark:bg-cool-gray-800 shadow rounded p-4">
            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-red-100 dark:bg-opacity-10 text-red-500">
        ...
        <div class="col-span-full  md:col-span-1">
          <div class="flex flex-row bg-white dark:bg-cool-gray-800 shadow rounded p-4">
            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-gray-100 dark:bg-opacity-10 text-gray-400">
        ...
        <div class="col-span-full  md:col-span-1">
          <div class="flex flex-row bg-white dark:bg-cool-gray-800 shadow rounded p-4">
            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-yellow-100 dark:bg-opacity-10 text-yellow-500">
        ...
        <div class="col-span-full  md:col-span-1">
          <div class="flex flex-row bg-white dark:bg-cool-gray-800 shadow rounded p-4">
            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-orange-100 dark:bg-opacity-10 text-orange-500">
          ...
          <template #default="{ item }">
            ...
            <td class="px-4 py-3 whitespace-nowrap">
              <div class="flex items-center">
                <div
                  v-tippy
                  class="flex-shrink-0 h-8 w-8 focus:outline-none"
