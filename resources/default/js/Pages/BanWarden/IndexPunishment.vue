        ...
        <div class="py-4 px-2 md:py-4 md:px-10 max-w-screen-2xl mx-auto">
            <div class="grid-cols-5 gap-4 mb-4 hidden md:grid">
                <div class="col-span-full md:col-span-1">
                    <Card>
                        <CardContent class="flex flex-row p-4">
                            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-sky-100 dark:bg-sky-500/10 text-sky-600 dark:text-sky-400">
                ...
                <div class="col-span-full md:col-span-1">
                    <Card>
                        <CardContent class="flex flex-row p-4">
                            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-error-100 dark:bg-error-500/10 text-error-600 dark:text-error-400">
                ...
                <div class="col-span-full md:col-span-1">
                    <Card>
                        <CardContent class="flex flex-row p-4">
                            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-surface-200 dark:bg-surface-500/10 text-surface-600 dark:text-surface-400">
                ...
                <div class="col-span-full md:col-span-1">
                    <Card>
                        <CardContent class="flex flex-row p-4">
                            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-warning-100 dark:bg-warning-500/10 text-warning-600 dark:text-warning-400">
                ...
                <div class="col-span-full md:col-span-1">
                    <Card>
                        <CardContent class="flex flex-row p-4">
                            <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-xl bg-orange-100 dark:bg-orange-500/10 text-orange-600 dark:text-orange-400">
                    ...
                    <template #default="{ item }">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                <div v-tippy class="flex-shrink-0 h-8 w-8 focus:outline-none" :content="item.country.name">
