...
import { DocumentMagnifyingGlassIcon, EyeIcon, PlusSmallIcon } from "@heroicons/vue/24/outline";
...
<template>
  <AppLayout>
      ...
      <div class="flex flex-col md:flex-row justify-between mb-8">
        ...
        <div class="flex space-x-2">
          <button
            ...
            class="inline-flex items-center px-4 py-2 bg-success border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-success/90 active:bg-success/80 focus:outline-hidden focus:border-success transition ease-in-out duration-150"
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="ml-2">
                      <Link
                        ...
                        class="font-medium text-foreground cursor-pointer focus:outline-hidden hover:underline"
                ...
                <div v-else-if="punishment.uuid">
                  <div class="flex items-center">
                    ...
                    <div class="ml-2">
                      ...
                      >
                        <span class="italic text-destructive">{{ __("Unknown") }}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <Card class="md:col-span-1">
            <CardContent>
              ...
              <div
                ...
                class="flex items-center justify-center w-full min-h-[250px] text-sm italic text-center"
              >
              ...
              <template #default="{ item }">
                ...
                <td class="px-3 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      v-tippy
                      class="shrink-0 w-8 h-8 focus:outline-hidden"
    ...
    <Dialog
      :open="showingPardonForm"
      @update:open="showingPardonForm = $event"
    >
      <DialogContent class="sm:max-w-[425px]">
        ...
        <DialogFooter>
          ...
          <LoadingButton
            ...
            class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-success border border-transparent rounded-md hover:bg-success/80 active:bg-success/80 focus:outline-hidden focus:border-success focus:shadow-outline-gray"
            @click="
              () => {
                pardonForm.delete(
    ...
    <Dialog
      :open="showingUploadDialog"
      @update:open="showingUploadDialog = $event"
    >
