...
"
 ...
 <div class="flex items-center">
 <div v-tippy class="shrink-0 w-8 h-8 focus:outline-hidden":content="item.country.name">
...
"
 ...
 <div class="ml-2">
 <Link v-tippy as="a":href="route('player.show', item.uuid)"class="text-sm font-medium text-foreground cursor-pointer focus:outline-hidden hover:underline":content="item.uuid">
