...
<template>
 ...
 <AlertCard v-if="success"text-color="text-success"border-color="border-success">
 <template #icon>
 <CheckCircleIcon class="fill-current h-6 w-6 text-success mr-4"/>
 </template>
 <h2 class="text-xl">
 ...
 <AlertCard v-if="cannotPlayerPasswordReset"text-color="text-destructive"border-color="border-destructive">
