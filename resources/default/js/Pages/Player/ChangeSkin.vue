...
<template>
 ...
 <AlertCard v-if="!hasServersWithFeature"text-color="text-destructive"border-color="border-destructive">
 <p class="text-sm">
 ...
 <AlertCard v-if="cooldown"text-color="text-yellow-800"border-color="border-yellow-500">
 {{
 ...
 <AlertCard v-if="!selectedPlayer"text-color="text-destructive"border-color="border-destructive">
