  ...
  <AppLayout>
    ...
    <div class="max-w-screen-xl px-2 py-3 mx-auto space-y-4 md:py-12 md:px-10">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <h2
          v-if="selectedPlayer"
          class="text-lg mb-2 md:mb-0 md:text-2xl font-bold text-foreground"
        >
          {{
        ...
        <h2
          v-else
          class="text-lg italic mb-2 md:mb-0 md:text-2xl font-bold text-foreground"
        >
        ...
        <div class="flex flex-col md:flex-row gap-4">
          <TabsList class="flex flex-col h-fit w-full md:w-64 space-y-2 p-2 border shadow">
            <TabsTrigger
              ...
              :key="tab.value"
              :value="tab.value"
              class="w-full justify-start py-2 px-4 text-left font-medium rounded-lg transition-all duration-200 hover:bg-accent/10"
            >
              {{ __(tab.label) }}
            </TabsTrigger>
          </TabsList>
            ...
            >
              <Card class="shadow-sm">
                ...
                <CardContent>
                  ...
                  <form
                    class="w-full border-t pt-4 border-border"
                    ...
                    <div class="col-span-6 sm:col-span-6 pt-4 space-y-3">
                      ...
                      <div class="flex gap-6">
                        <input
                          ...
                          accept=".png"
                          type="file"
                          class="block p-2 w-full text-sm text-foreground border border-input rounded-lg cursor-pointer bg-background focus:outline-hidden placeholder:text-muted-foreground"
                          required
                        >
                      </div>
                      <p
