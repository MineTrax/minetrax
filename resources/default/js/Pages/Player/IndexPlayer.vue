<template>
 ...
 <div
 class="flex items-center justify-center shrink-0 h-12 w-12 rounded-xl bg-primary/10 text-primary">
 ...
 <div class="flex flex-row">
 <div
 class="flex items-center justify-center shrink-0 h-12 w-12 rounded-xl bg-success/10 text-success">
 <Users2Icon class="w-6 h-6"/>
 </div>
 <div class="flex flex-col grow ml-4">
 <div class="text-sm text-muted-foreground">
 ...
 <div class="flex flex-row">
 <div
 class="flex items-center justify-center shrink-0 h-12 w-12 rounded-xl bg-purple-500/10 text-purple-500">
 ...
 <div class="flex flex-row">
 <div
 class="flex items-center justify-center shrink-0 h-12 w-12 rounded-xl bg-pink-500/10 text-pink-500">
...
'bg-muted/20': index % 2 === 1,
 ...
 <div v-tippy class="shrink-0 h-10 w-10 focus:outline-hidden"
...
"alt=""/>
 ...
 <div v-tippy class="shrink-0 focus:outline-hidden":content="player.rank.name
">
...
"Unknown"
 ...
 <icon v-tippy class="w-10 h-10 focus:outline-hidden"
 ...
 <td class="px-6 py-4 whitespace-nowrap text-sm text-card-foreground">
 <span v-tippy class="focus:outline-hidden":content="formatToDayDateString(
 player.last_seen_at
 )
">
 {{
