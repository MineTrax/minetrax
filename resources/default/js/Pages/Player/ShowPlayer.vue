            ...
            <div class="grid grid-cols-2 gap-4 md:grid-cols-4 md:divide-x divide-border">
              ...
              <div class="flex flex-col items-center justify-center px-4 py-2 md:py-0">
                <div class="text-primary font-extrabold text-2xl">
                  ...
                  <span
                    v-else
                    class="text-muted-foreground text-base font-normal italic"
                  >{{ __("None") }}</span>
                </div>
              ...
              <div class="flex flex-col items-center justify-center px-4 py-2 md:py-0">
                <img
                  ...
                  class="h-10 focus:outline-hidden"
                >
                <span
                  v-else
                  class="italic text-muted-foreground"
              ...
              <div class="flex flex-col items-center justify-center px-4 py-2 md:py-0">
                <img
                  ...
                  class="h-10 w-10 focus:outline-hidden"
                >
                <span
                  v-else
                  class="italic text-muted-foreground"
            ...
            <CardHeader>
              <div class="flex justify-between items-start">
                <div>
                  ...
                  <p class="text-muted-foreground text-sm font-mono mt-1">
                    {{ player.uuid }}
                  </p>
                </div>
                <div
                  v-if="!player.is_active"
                  class="bg-destructive/10 text-destructive text-xs font-semibold px-2.5 py-0.5 rounded"
                >
                  {{ __("Inactive") }}
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-4">
                  <div class="flex items-center space-x-2 border-b pb-2 mb-2">
                    <FireIcon class="w-5 h-5 text-destructive" />
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                      ...
                      <div class="flex justify-between items-center">
                        ...
                        >{{ player.favorite_server.name }}</span>
                        <span
                          v-else
                          class="italic text-muted-foreground"
                        >{{ __("None") }}</span>
                    ...
                    <div class="space-y-4">
                      <div class="flex items-center space-x-2 border-b pb-2 mb-2">
                        <UserIcon class="w-5 h-5 text-success" />
                        <h3 class="font-semibold text-lg">
                          {{ __("Account") }}
                        </h3>
                      </div>
