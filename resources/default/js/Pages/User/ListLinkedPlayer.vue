    ...
    <div class="max-w-screen-xl space-y-4 mx-auto py-4 px-2 sm:py-6 sm:px-4 lg:px-8">
      ...
      >
        ...
        <div
          ...
          class="absolute inset-0 bg-destructive/10 backdrop-blur-md z-10 flex items-center justify-center"
        >
        ...
        <CardContent
          class="pt-6 transition-all duration-300"
          :class="{ 'blur-sm': otpExpiryCountdownSeconds <= 0 }"
        >
          <div class="flex">
            <div class="py-1">
              <svg
            ...
            <div class="w-full">
              <p
                class="font-bold"
                :class="linkSlotsLeft > 0 ? 'text-primary' : 'text-orange-900 dark:text-orange-400'"
              >
      ...
      >
        <div
          ...
          class="flex justify-center pt-5 pb-5"
        >
          ...
          <CardContent class="p-4">
            <div class="flex flex-col items-center">
                ...
                <div class="flex flex-col space-y-2">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2 text-sm font-extrabold text-center text-primary">
                      <span
                        ...
                        class="px-2 text-lg border-2 rounded border-primary bg-primary/10"
                      >
                        {{ player.position }}
                      </span>
                      <span
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                      <p
                        v-tippy
                        class="focus:outline-hidden text-foreground"
              ...
              <div class="flex justify-end space-x-2 mt-4 w-full">
                <Button
                  v-if="pageProps.pluginSettings?.playerPasswordResetEnabled"
                  v-tippy
                  as-child
                  variant="outline"
                  size="sm"
                ...
                <Button
                  v-if="pageProps.playerSkinChangerEnabled"
                  v-tippy
                  as-child
                  variant="default"
                  size="sm"
...
import { BookmarkSlashIcon, LockClosedIcon, PaintBrushIcon } from "@heroicons/vue/24/solid";
