...
<template>
  ...
  >
    ...
    >
      <div class="shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
        <InertiaLink
      ...
      <div class="flex flex-col flex-wrap grow mt-10 -mb-10 text-center md:flex-row md:pl-20 md:mt-0 md:text-left">
        <div
    ...
    >
      ...
      >
        {{ __("Powered with") }}
        <Icon
          class="absolute inline-flex w-4 h-4 text-destructive opacity-75 animate-ping"
          name="heart-fill"
        />
        <Icon
          class="relative inline-flex w-4 h-4 text-destructive"
          name="heart-fill"
        />
        by <a
          target="_blank"
