...
<template>
  <Card class="w-full">
    ...
    <CardContent class="pt-0">
      ...
      <div
        v-if="error"
        class="p-3 text-center bg-destructive/10 text-destructive"
      >
        {{ error.message }}
      </div>
            ...
            >
              <thead>
                <tr>
                  <th
                    scope="col"
                    class="p-4 text-xs font-medium tracking-wider text-left text-muted-foreground uppercase whitespace-nowrap"
                  >
                    {{ __("Metric") }}
                  </th>
                  <th
