...
<template>
  <div class="bg-white dark:bg-surface-800 rounded w-full shadow">
    <h3 class="p-3 font-extrabold text-secondary-800 dark:text-secondary-200 flex items-center">
      {{ __("Network Trends") }}
    </h3>
    ...
    <div class="flex flex-col">
      ...
      <div class="overflow-x-auto">
        <div class="inline-block min-w-full align-middle">
          <div class="overflow-hidden shadow-lg shadow-secondary-200">
            <table
            ...
            >
              <thead>
                <tr>
                  <th
                    scope="col"
                    class="p-4 text-xs font-medium tracking-wider text-left text-secondary-500 dark:text-secondary-400 uppercase whitespace-nowrap"
                  >
                    {{ __("Metric") }}
                  </th>
                  <th
              ...
              <tbody class="divide-y divide-secondary-200 dark:divide-secondary-700">
                <tr>
                  <td class="flex items-center p-4 text-sm font-normal text-secondary-900 dark:text-secondary-300 whitespace-nowrap">
                    <UserGroupIcon
                    ...
                    <span
                      ...
                      class="mx-5 ml-3 w-32 font-medium text-secondary-900 dark:text-secondary-300 sm:flex-none"
                    >{{ __("Total Players") }}</span>
                  </td>
                  <td class="p-4 text-sm font-semibold text-secondary-900 dark:text-secondary-300 whitespace-nowrap">
                  ...
                  <td
                    ...
                    :class="{'text-error-500 font-semibold' : data.total_players.change < 0, 'text-success-500 font-semibold' : data.total_players.change > 0, 'text-secondary-500 dark:text-secondary-400 font-normal' : data.total_players.change == 0}"
                  >
                ...
                <tr>
                  ...
                  <td
                    class="p-4 text-sm whitespace-nowrap"
                    :class="{'text-error-500 font-semibold' : data.total_new_players.change < 0, 'text-success-500 font-semibold' : data.total_new_players.change > 0, 'text-secondary-500 dark:text-secondary-400 font-normal' : data.total_new_players.change == 0}"
                  >
                ...
                <tr>
                  <td class="flex items-center p-4 text-sm font-normal text-secondary-900 dark:text-secondary-300 whitespace-nowrap">
                    ...
                    <span
                      ...
                      class="flex-none mx-5 ml-3 w-32 font-medium text-secondary-900 dark:text-secondary-300"
                  ...
                  <td
                    class="p-4 text-sm whitespace-nowrap"
                    :class="{'text-error-500 font-semibold' : data.total_player_sessions.change < 0, 'text-success-500 font-semibold' : data.total_player_sessions.change > 0, 'text-secondary-500 dark:text-secondary-400 font-normal' : data.total_player_sessions.change == 0}"
                  >
                ...
                <tr>
                  ...
                  <td
                    class="p-4 text-sm whitespace-nowrap"
                    :class="{'text-error-500 font-semibold' : data.avg_playtime.change < 0, 'text-success-500 font-semibold' : data.avg_playtime.change > 0, 'text-secondary-500 dark:text-secondary-400 font-normal' : data.avg_playtime.change == 0}"
                  >
                ...
                <tr>
                  ...
                  <td
                    class="p-4 text-sm whitespace-nowrap"
                    :class="{'text-success-500 font-semibold' : data.avg_afktime.change < 0, 'text-error-500 font-semibold' : data.avg_afktime.change > 0, 'text-secondary-500 dark:text-secondary-400 font-normal' : data.avg_afktime.change == 0}"
                  >
                ...
                <tr>
                  ...
                  <td
                    class="p-4 text-sm whitespace-nowrap"
                    :class="{'text-success-500 font-semibold' : data.avg_player_ping.change < 0, 'text-error-500 font-semibold' : data.avg_player_ping.change > 0, 'text-secondary-500 dark:text-secondary-400 font-normal' : data.avg_player_ping.change == 0}"
                  >
                ...
                <tr>
                  <td class="flex items-center p-4 text-sm font-normal text-secondary-900 dark:text-secondary-300 whitespace-nowrap">
                    <ArrowTrendingUpIcon class="w-5 h-5 text-primary-400" />
                    <span
                      v-tippy="{trigger: 'click'}"
                  ...
                  <td
                    class="p-4 text-sm whitespace-nowrap"
                    :class="{'text-error-500 font-semibold' : data.peek_online_players.change < 0, 'text-success-500 font-semibold' : data.peek_online_players.change > 0, 'text-secondary-500 dark:text-secondary-400 font-normal' : data.peek_online_players.change == 0}"
                  >
