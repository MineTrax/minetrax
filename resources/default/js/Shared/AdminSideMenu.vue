...
const navItems = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                label: "Variables",
                href: route("admin.store.variable.index"),
                active: route().current("admin.store.variable.*"),
                children: [],
                icon: null,
                visible: canWild("store_variables"),
            },
            {
                label: "Coupons",
                href: route("admin.store.coupon.index"),
                active: route().current("admin.store.coupon.*"),
                children: [],
                icon: null,
