      ...
      >
        <div class="w-full max-w-sm mx-auto">
          <div class="flex space-x-4 animate-pulse">
            <div class="w-8 h-8 bg-muted rounded dark:bg-accent" />
            <div class="flex-1 py-1 space-y-1">
              <div class="w-3/4 h-4 bg-muted rounded dark:bg-accent" />
              <div class="w-5/6 h-4 bg-muted rounded dark:bg-accent" />
            </div>
          </div>
        </div>
      </div>
