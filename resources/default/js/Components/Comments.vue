<template>
 ...
 >
 <button
 class="text-sm font-semibold text-foreground dark:text-foreground focus:outline-hidden hover:underline"
 ...
 <span
 v-tippy
 class="inline ml-1 text-xs text-muted-foreground focus:outline-hidden"
 ...
 class="order-3 focus:outline-hidden text-muted-foreground"
 >
 <icon
 name="trash"
 ...
 >
 <div class="grow order-2 mx-2 text-sm">
