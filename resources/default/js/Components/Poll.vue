<template>
  <div class="vue-poll">
    <h3
      class="qst dark:text-foreground"
      v-html="question"
    />
    <div class="ans-cnt">
      <div
      ...
      >
        <template v-if="!finalResults">
          <div
            v-if="!visibleResults"
            class="hover:bg-primary dark:hover:bg-surface-900"
          ...
          <div
            v-else
            :class="{ 'ans-voted dark:text-foreground': true, selected: a.selected }"
          >
            <span
              v-if="a.percent"
              class="percent"
        ...
        <template v-else>
          <div :class="{ 'ans-voted final dark:text-foreground': true, selected: a.selected }">
            <span
              v-if="a.percent"
              class="percent"
              v-text="a.percent"
          ...
          <span
            :class="{ 'bg bg-surface-200 dark:bg-surface-700': true, 'bg-primary dark:bg-primary': mostVotes == a.votes }"
