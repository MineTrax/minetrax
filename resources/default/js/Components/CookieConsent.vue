<template>
  <div
    v-if="show"
    class="z-50 fixed p-2 bottom-0 bg-black w-full text-secondary-300 text-center bg-opacity-90 dark:bg-opacity-60"
  >
    <div>
      <span>
      ...
      <button
        class="text-primary-400 cursor-pointer ml-0.5 hover:text-primary-500"
        @click.prevent="close"
      >
        {{ __("I Understand") }}
      </button>
