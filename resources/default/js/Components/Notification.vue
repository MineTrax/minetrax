          ...
          <div class="flex items-start justify-between">
            ...
            <div class="flex items-center gap-2 shrink-0 ml-3">
              ...
              <button
                ...
                @click.prevent.stop="markAsReadSilently"
              >
                <LoaderIcon
                  v-if="gettingMarkedAsRead"
