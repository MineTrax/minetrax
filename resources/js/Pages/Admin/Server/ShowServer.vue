    ...
    <div class="py-12 px-10 max-w-6xl mx-auto space-y-4">
      ...
      <div class="flex space-x-2 justify-between">
        <overview-card
          ...
          :value="onlinePlayers"
          :desc="`Maximum limit: ${maxPlayersAllowed}`"
        ...
        <overview-card
          ...
          :desc="`Mob Kills: ${millify(serverAggrData.mob_kills, {precision: 2})}`"
        ...
        <overview-card
          ...
          :desc="`Total Damage: ${millify(serverAggrData.player_damage_taken, {precision: 2})}`"
          color="text-red-500"
        ...
        <overview-card
          ...
          :desc="`${serverAggrData.active_players} active players`"
        ...
        <div class="flex justify-between dark:border-gray-700 space-x-8">
          <div class="flex-1 space-y-4">
            <div class="flex justify-between">
              ...
              <p>
                <span>{{ server.is_ingame_chat_enabled ? 'Yes' : 'No' }}</span>
              </p>
            </div>
            <div class="flex justify-between">
              <div class="flex">
              ...
              <p>{{ server.is_online_players_query_enabled ? 'Yes' : 'No' }}</p>
            </div>
          </div>
          <div class="flex-1 space-y-4">
            <div class="flex justify-between">
              ...
              <p>
                <span>{{ server.is_stats_tracking_enabled ? 'Yes' : 'No' }}</span>
              </p>
            </div>
            <div class="flex justify-between">
              <div class="flex">
