<template>
  ...
  >
    ...
    <div
      ...
      :class="[$page.props.disableEmailPasswordAuth ? 'flex-col space-y-4' : '']"
    >
      <a
...
export default {
    ...
    computed: {
        shouldDisplayThisPage:  function () {
            return this.$page.props.enabledSocialAuths &&  Object.values(this.$page.props.enabledSocialAuths).some(auth => auth);
        }
    }
};
</script>
