...
const classes = {
    ...
    'family:dropdown__listitem': {
        ...
        'dark:aria-selected:text-gray-700': true,
        'dark:data-[is-active]:text-gray-700': true,
        'before:content-[\'\']': true,
        'before:absolute': true,
        'before:inset-0': true,
        'data-[is-active]:aria-selected:before:ring-2': true,
        'data-[is-active]:aria-selected:before:ring-sky-500': true,
        'data-[is-active]:aria-selected:before:ring-inset': true,
        'data-[is-active]:aria-selected:before:ring-offset-sky-100': true
    },
