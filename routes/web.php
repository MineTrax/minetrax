...
Route::middleware(['auth:sanctum', 'verified-if-enabled', 'forbid-banned-user', 'staff-member', 'redirect-uncompleted-user'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('setting/danger/backup-database', [DangerSettingController::class, 'exportDatabaseBackup'])->name('setting.danger.backup.database');
    Route::get('setting/danger/backup-download/{backupRun}', [DangerSettingController::class, 'downloadBackup'])->name('setting.danger.backup.download');
    Route::delete('setting/danger/backup-delete/{backupRun}', [DangerSettingController::class, 'deleteBackup'])->name('setting.danger.backup.delete');
