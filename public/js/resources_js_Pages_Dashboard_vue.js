...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      format: date_fns__WEBPACK_IMPORTED_MODULE_2__.default,
      comments: null,
      loading: true,
      loadingMore: false,
      commentBody: '',
  ...
  created: function created() {
    ...
    axios.get(route('post.comment.index', this.post.id)).then(function (response) {
  ...
  methods: {
    loadMoreComments: function loadMoreComments() {
      ...
      return axios(this.comments.next_page_url).then(function (response) {
        _this2.comments = _objectSpread(_objectSpread({}, response.data), {}, {
          data: [].concat(_toConsumableArray(response.data.data.reverse()), _toConsumableArray(_this2.comments.data))
        });
      })["finally"](function (x) {
    ...
    submitComment: function submitComment() {
      ...
      axios.post(route('post.comment.store', this.post.id), {
        ...
        if (response.status === 200) {
          _this3.comments.data.push(response.data.data); // Set Body to empty


          _this3.commentBody = '';
        }
      })["catch"](function (error) {
        if (error.response.status === 422) _this3.bodyerror = error.response.data.errors.comment[0];else _this3.bodyerror = error.response.data.message;
      })["finally"](function () {
        _this3.submitting = false; // Wait for next tick coz component is re-rendered (it check if component is visible with v-if)

        _this3.$nextTick(function () {
          _this3.$refs.comment.focus();
        });
      });
    }
  }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/CopyToClipboard.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/CopyToClipboard.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    copy: function copy(text) {
      ...
      // create textarea
      var el = document.createElement('textarea'); // assign value

      el.value = text; // style textarea

      el.style.position = 'absolute';
      el.style.left = '-90000px';
      document.body.appendChild(el); // select its contents

      el.select(); // execute copy
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Poll.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Poll.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/formatDistanceToNowStrict/index.js");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      formatDistanceToNowStrict: date_fns__WEBPACK_IMPORTED_MODULE_0__.default
    };
  },
  computed: {
    totalVotes: function totalVotes() {
      var totalVotes = 0;
      this.answers.filter(function (a) {
        if (!isNaN(a.votes) && a.votes > 0) totalVotes += parseInt(a.votes);
      });
      return totalVotes;
    },
    totalVotesFormatted: function totalVotesFormatted() {
      return this.totalVotes.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
    },
    mostVotes: function mostVotes() {
      var max = 0;
      this.answers.filter(function (a) {
    ...
    calcAnswers: function calcAnswers() {
      var _this = this;

      if (this.totalVotes === 0) return this.answers.map(function (a) {
        a.percent = '0%';
        return a;
      }); //Calculate percent

      return this.answers.filter(function (a) {
        if (!isNaN(a.votes) && a.votes > 0) a.percent = Math.round(parseInt(a.votes) / _this.totalVotes * 100) + '%';else a.percent = '0%';
        return a;
      });
    },
    totalSelections: function totalSelections() {
      return this.calcAnswers.filter(function (a) {
        return a.selected;
      }).length;
    }
  },
  methods: {
    handleMultiple: function handleMultiple() {
      var arSelected = [];
      this.calcAnswers.filter(function (a) {
        if (a.selected) {
          a.votes++;
          arSelected.push({
            value: a.value,
    ...
    handleVote: function handleVote(a) {
      //Callback
...
/* harmony import */ var _Components_Comments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/Components/Comments */ "./resources/js/Components/Comments.vue");
/* harmony import */ var autolinker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! autolinker */ "./node_modules/autolinker/dist/es2015/index.js");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    Comments: _Components_Comments__WEBPACK_IMPORTED_MODULE_3__.default,
  ...
  data: function data() {
    var _this$post$love_react, _this$post$love_react2, _this$post$love_react3, _this$post, _this$post$love_react4, _this$post$love_react5;

    return {
      formatDistanceToNowStrict: date_fns__WEBPACK_IMPORTED_MODULE_5__.default,
      format: date_fns__WEBPACK_IMPORTED_MODULE_6__.default,
      liked: ((_this$post$love_react = this.post.love_reactant) === null || _this$post$love_react === void 0 ? void 0 : (_this$post$love_react2 = _this$post$love_react.reactions) === null || _this$post$love_react2 === void 0 ? void 0 : _this$post$love_react2.length) > 0,
      likes_count: (_this$post$love_react3 = (_this$post = this.post) === null || _this$post === void 0 ? void 0 : (_this$post$love_react4 = _this$post.love_reactant) === null || _this$post$love_react4 === void 0 ? void 0 : (_this$post$love_react5 = _this$post$love_react4.reaction_total) === null || _this$post$love_react5 === void 0 ? void 0 : _this$post$love_react5.count) !== null && _this$post$love_react3 !== void 0 ? _this$post$love_react3 : 0,
  ...
  methods: {
    likePost: function likePost() {
      ...
      this.liked = true;
      this.likes_count++;
      axios.post(route('reaction.post.like', this.post.id)).then(function (response) {})["catch"](function (err) {
        _this.liked = false;
        _this.likes_count--;
      });
    },
    unlikePost: function unlikePost() {
      ...
      this.liked = false;
      this.likes_count--;
      axios.post(route('reaction.post.unlike', this.post.id)).then(function (response) {})["catch"](function (err) {
        _this2.liked = true;
        _this2.likes_count++;
      });
    }
...
/* harmony import */ var _Shared_NewsBox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/Shared/NewsBox */ "./resources/js/Shared/NewsBox.vue");
/* harmony import */ var _Shared_ShoutBox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/Shared/ShoutBox */ "./resources/js/Shared/ShoutBox.vue");
/* harmony import */ var _Shared_DiscordServerBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/Shared/DiscordServerBox */ "./resources/js/Shared/DiscordServerBox.vue");
/* harmony import */ var _Shared_NewestUserBox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/Shared/NewestUserBox */ "./resources/js/Shared/NewestUserBox.vue");
/* harmony import */ var _Shared_VotingSitesBox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/Shared/VotingSitesBox */ "./resources/js/Shared/VotingSitesBox.vue");
/* harmony import */ var _Shared_WelcomeBox__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/Shared/WelcomeBox */ "./resources/js/Shared/WelcomeBox.vue");
/* harmony import */ var _Shared_PostListBox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/Shared/PostListBox */ "./resources/js/Shared/PostListBox.vue");
/* harmony import */ var _Shared_LatestPinnedNews__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/Shared/LatestPinnedNews */ "./resources/js/Shared/LatestPinnedNews.vue");
/* harmony import */ var _Shared_SocialChannelBox__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/Shared/SocialChannelBox */ "./resources/js/Shared/SocialChannelBox.vue");
/* harmony import */ var _Shared_DidYouKnowBox__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/Shared/DidYouKnowBox */ "./resources/js/Shared/DidYouKnowBox.vue");
/* harmony import */ var _Shared_OnlinePlayersBox__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/Shared/OnlinePlayersBox */ "./resources/js/Shared/OnlinePlayersBox.vue");
/* harmony import */ var _Shared_IngameChatBox__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @/Shared/IngameChatBox */ "./resources/js/Shared/IngameChatBox.vue");
/* harmony import */ var _Shared_ServerStatusBox__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @/Shared/ServerStatusBox */ "./resources/js/Shared/ServerStatusBox.vue");
/* harmony import */ var _Shared_PollBox__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @/Shared/PollBox */ "./resources/js/Shared/PollBox.vue");
/* harmony import */ var _Shared_DonationBox__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @/Shared/DonationBox */ "./resources/js/Shared/DonationBox.vue");
/* harmony import */ var _Shared_OnlineUsersBox__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @/Shared/OnlineUsersBox */ "./resources/js/Shared/OnlineUsersBox.vue");
/* harmony import */ var _Shared_TopPlayersListBox__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @/Shared/TopPlayersListBox */ "./resources/js/Shared/TopPlayersListBox.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    TopPlayersListBox: _Shared_TopPlayersListBox__WEBPACK_IMPORTED_MODULE_17__.default,
    OnlineUsersBox: _Shared_OnlineUsersBox__WEBPACK_IMPORTED_MODULE_16__.default,
    DonationBox: _Shared_DonationBox__WEBPACK_IMPORTED_MODULE_15__.default,
    PollBox: _Shared_PollBox__WEBPACK_IMPORTED_MODULE_14__.default,
    ServerStatusBox: _Shared_ServerStatusBox__WEBPACK_IMPORTED_MODULE_13__.default,
    IngameChatBox: _Shared_IngameChatBox__WEBPACK_IMPORTED_MODULE_12__.default,
    OnlinePlayersBox: _Shared_OnlinePlayersBox__WEBPACK_IMPORTED_MODULE_11__.default,
    DidYouKnowBox: _Shared_DidYouKnowBox__WEBPACK_IMPORTED_MODULE_10__.default,
    SocialChannelBox: _Shared_SocialChannelBox__WEBPACK_IMPORTED_MODULE_9__.default,
    PostListBox: _Shared_PostListBox__WEBPACK_IMPORTED_MODULE_7__.default,
    WelcomeBox: _Shared_WelcomeBox__WEBPACK_IMPORTED_MODULE_6__.default,
    NewsBox: _Shared_NewsBox__WEBPACK_IMPORTED_MODULE_1__.default,
    AppLayout: _Layouts_AppLayout__WEBPACK_IMPORTED_MODULE_0__.default,
    ShoutBox: _Shared_ShoutBox__WEBPACK_IMPORTED_MODULE_2__.default,
    DiscordServerBox: _Shared_DiscordServerBox__WEBPACK_IMPORTED_MODULE_3__.default,
    NewestUserBox: _Shared_NewestUserBox__WEBPACK_IMPORTED_MODULE_4__.default,
    VotingSitesBox: _Shared_VotingSitesBox__WEBPACK_IMPORTED_MODULE_5__.default,
    LatestPinnedNews: _Shared_LatestPinnedNews__WEBPACK_IMPORTED_MODULE_8__.default
  },
  props: {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DidYouKnowBox.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DidYouKnowBox.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    axios.get(route('didyouknow.get')).then(function (data) {
      _this.text = data.data.text;
      _this.imageUrl = data.data.image;
    })["finally"](function (e) {
      _this.loading = false;
    });
  },
  ...
  methods: {
    isInViewport: function isInViewport() {
      ...
      var rect = (_this$$refs$box = this.$refs.box) === null || _this$$refs$box === void 0 ? void 0 : _this$$refs$box.getBoundingClientRect();
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DiscordServerBox.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DiscordServerBox.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DonationBox.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DonationBox.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  computed: {
    ...
    donationText: function donationText() {
      return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.sample)(['Help us run our servers!', 'Your help mean everything to us!', 'If you are capable, we would appreciate your contribution']);
    }
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/IngameChatBox.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/IngameChatBox.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    serverId: function serverId(newId, oldId) {
      var _this = this;
      ...
      this.playerListQueryInterval = setInterval(function () {
        return _this.getPlayerListForServer(newId);
      }, 10000);
    }
  },
  created: function created() {
    ...
    this.playerListQueryInterval = setInterval(function () {
      return _this2.getPlayerListForServer(_this2.serverId);
    }, 10000);
  },
  destroyed: function destroyed() {
  ...
  methods: {
    postSendMessage: function postSendMessage() {
      var _this3 = this;
      ...
      axios.post(route('chatlog.send', this.serverId), {
        ...
        if (e.response.status === 422) _this3.error = Object.values(e.response.data.errors)[0][0];else if (e.response.status === 403) _this3.error = e.response.data.message;else _this3.error = e.response.statusText;
      })["finally"](function (e) {
        _this3.message = '';
        _this3.sending = false;

        _this3.$nextTick(function () {
          _this3.$refs.inputbox.focus();
        });
      });
    },
    getChatListForServer: function getChatListForServer(sId) {
      var _this4 = this;

      this.loading = true;
      this.chatLogs = [];
      axios.get(route('chatlog.index', sId)).then(function (data) {
        _this4.chatLogs = data.data.reverse();
      })["finally"](function (e) {
        _this4.loading = false;

        _this4.$nextTick(function () {
          var scrollHeight = _this4.$el.querySelector('#chatbox').scrollHeight;

          _this4.$el.querySelector('#chatbox').scrollTo(0, scrollHeight);
        });
      });
      Echo.channel('chatlogs.' + sId).listen('ServerChatlogCreated', function (data) {
        _this4.chatLogs.push(data.data);
    ...
    getPlayerListForServer: function getPlayerListForServer(sId) {
      var _this5 = this;

      axios.get(route('server.webquery.get', sId)).then(function (data) {
        _this5.playersList = data.data;
      })["catch"](function (e) {
        _this5.shouldDisplayPlayerList = false;
      })["finally"](function (e) {
        _this5.playersListLoading = false;
      });
    },
    openAdminPlayerActionModel: function openAdminPlayerActionModel(player) {
      this.showAdminPlayerActionModel = true;
      this.actionModelCurrentPlayer = player;
    },
    closeAdminPlayerActionModel: function closeAdminPlayerActionModel() {
      this.showAdminPlayerActionModel = false;
      this.actionModelCurrentPlayer = null;
    },
    sendCommandToServer: function sendCommandToServer(type) {
      var _this6 = this;
      ...
      axios.post(route('admin.server.command', this.serverId), formJson).then(function (data) {
        _this6.closeAdminPlayerActionModel();
      })["catch"](function (e) {
        _this6.adminPlayerActionError = e.message;
      })["finally"](function () {
        _this6.adminPlayerActionLoading = false;
      });
    }
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/LatestPinnedNews.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/LatestPinnedNews.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewestUserBox.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewestUserBox.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      formatDistanceToNowStrict: date_fns__WEBPACK_IMPORTED_MODULE_0__.default,
      format: date_fns__WEBPACK_IMPORTED_MODULE_1__.default
    };
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewsBox.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewsBox.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlinePlayersBox.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlinePlayersBox.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getServerQuery: function getServerQuery() {
      var _this2 = this;

      var serverToQuery = this.server;

      if (!serverToQuery) {
        serverToQuery = this.$page.props.defaultQueryServer;
      }

      axios.get(route('server.query.get', serverToQuery.id)).then(function (data) {
        _this2.serverInfo = data.data.server_info;
        _this2.playersList = data.data.players_list;
        _this2.error = null; // Change avatar size according to number of people

        if (Object.keys(_this2.playersList).length <= 5) {
          _this2.sizeClass = 'w-8 h-8';
        }
      })["catch"](function (err) {
        _this2.error = err.response.data.message || err.message;
        _this2.serverInfo = null;
        _this2.playersList = null;
      })["finally"](function (e) {
        _this2.loading = false;
      });
    }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlineUsersBox.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlineUsersBox.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    onlineMembers: function onlineMembers() {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PollBox.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PollBox.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Components_Poll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/Components/Poll */ "./resources/js/Components/Poll.vue");
//
//
//
//
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PostListBox.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PostListBox.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    Post: _Components_Post__WEBPACK_IMPORTED_MODULE_4__.default
  },
  props: {
    username: {
      type: [String],
  ...
  data: function data() {
    return {
      ...
      bodyPlaceholderText: (0,lodash_collection__WEBPACK_IMPORTED_MODULE_5__.sample)(['🎉 What\'s up?', '✨ What\'s happening?', '🍕 Having fun? Tell us about it.', '🎃 Are you alex or steve?', '👽 Have you seen Herobrine?']),
      imagesDisplay: []
    };
  },
  created: function created() {
    ...
    var routeToHit = route('post.index');
  ...
  methods: {
    loadMorePosts: function loadMorePosts() {
      ...
      return axios(this.posts.next_page_url).then(function (response) {
        _this2.posts = _objectSpread(_objectSpread({}, response.data), {}, {
          data: [].concat(_toConsumableArray(_this2.posts.data), _toConsumableArray(response.data.data))
        });
      });
    },
    submitPost: function submitPost() {
      ...
      axios.post(route('post.store'), formData).then(function (response) {
        if (response.status === 200) {
          _this3.posts.data.unshift(response.data.data); // Set Body to empty and resize the textarea to initial


          _this3.body = '';
          _this3.imagesDisplay = [];
          var textarea = _this3.$refs['post-content'];
          textarea.style.height = 'initial';
        }
      })["catch"](function (error) {
        if (error.response.status === 422) {
          _this3.bodyerror = Object.values(error.response.data.errors)[0][0];
        } else {
          _this3.bodyerror = error.response.data.message;
        }
      })["finally"](function () {
        return _this3.postsubmitting = false;
      });
    },
    resizeTextArea: function resizeTextArea() {
      var textarea = this.$refs['post-content'];
      textarea.style.height = 'initial';
      textarea.style.height = "".concat(textarea.scrollHeight, "px");
    },
    openImageSelector: function openImageSelector() {
      this.$refs.file_selector.click();
    },
    handleImageChangeListener: function handleImageChangeListener(ev) {
      var _this4 = this;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ServerStatusBox.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ServerStatusBox.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Components_CopyToClipboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/Components/CopyToClipboard */ "./resources/js/Components/CopyToClipboard.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getServerQuery: function getServerQuery() {
      ...
      axios.get(route('server.ping.get', serverToQuery.id)).then(function (data) {
        _this2.serverInfo = data.data;
        _this2.error = null;
      })["catch"](function (err) {
        _this2.error = err.response.data.message || err.message;
        _this2.serverInfo = null;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ShoutBox.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ShoutBox.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    axios.get(route('shout.index')).then(function (data) {
      _this.shouts = data.data;
    })["finally"](function (e) {
      _this.loading = false;
    });
    Echo.channel('shouts').listen('ShoutCreated', function (data) {
      _this.shouts.unshift(data.data);
    });
  },
  methods: {
    sendShout: function sendShout() {
      ...
      axios.post(route('shout.store'), {
        ...
        if (data.status === 200) {
          _this2.shouts.unshift(data.data);
        }
      })["catch"](function (e) {
        if (e.response.status === 422) _this2.error = e.response.data.errors.message[0];else if (e.response.status === 403) _this2.error = e.response.data.message;else _this2.error = 'Something went wrong';
      })["finally"](function (e) {
        _this2.message = '';
        _this2.sending = false;

        _this2.$nextTick(function () {
          _this2.$refs.inputbox.focus();
        });
      });
    }
  }
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/SocialChannelBox.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/SocialChannelBox.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    show: function show() {
      return !!this.youtube || !!this.facebook || !!this.twitter || !!this.twitter || !!this.website || !!this.steam || !!this.discord;
    }
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/TopPlayersListBox.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/TopPlayersListBox.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      format: date_fns__WEBPACK_IMPORTED_MODULE_1__.default,
      formatDistanceToNowStrict: date_fns__WEBPACK_IMPORTED_MODULE_2__.default
    };
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/VotingSitesBox.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/VotingSitesBox.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/WelcomeBox.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/WelcomeBox.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Poll.vue?vue&type=style&index=0&lang=css&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Poll.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PostListBox.vue?vue&type=style&index=0&id=b352cb3e&scoped=true&lang=css&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PostListBox.vue?vue&type=style&index=0&id=b352cb3e&scoped=true&lang=css& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.list-item[data-v-b352cb3e] {\r\n    display: inline-block;\r\n    margin-right: 10px;\n}\n.list-enter-active[data-v-b352cb3e], .list-leave-active[data-v-b352cb3e] {\r\n    transition: all 1s;\n}\n.list-enter[data-v-b352cb3e], .list-leave-to[data-v-b352cb3e] /* .list-leave-active below version 2.1.8 */\r\n{\r\n    opacity: 0;\r\n    transform: translateY(30px);\n}\r\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Poll_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Poll.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Poll.vue?vue&type=style&index=0&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Poll_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PostListBox_vue_vue_type_style_index_0_id_b352cb3e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PostListBox.vue?vue&type=style&index=0&id=b352cb3e&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PostListBox.vue?vue&type=style&index=0&id=b352cb3e&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_PostListBox_vue_vue_type_style_index_0_id_b352cb3e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__.default, options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Comments_vue_vue_type_template_id_0473b13f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Comments.vue?vue&type=template&id=0473b13f& */ "./resources/js/Components/Comments.vue?vue&type=template&id=0473b13f&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _Comments_vue_vue_type_template_id_0473b13f___WEBPACK_IMPORTED_MODULE_0__.render,
  _Comments_vue_vue_type_template_id_0473b13f___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CopyToClipboard_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CopyToClipboard.vue?vue&type=script&lang=js& */ "./resources/js/Components/CopyToClipboard.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_1__.default)(
  _CopyToClipboard_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Poll_vue_vue_type_template_id_0f0fdf0a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Poll.vue?vue&type=template&id=0f0fdf0a& */ "./resources/js/Components/Poll.vue?vue&type=template&id=0f0fdf0a&");
/* harmony import */ var _Poll_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Poll.vue?vue&type=script&lang=js& */ "./resources/js/Components/Poll.vue?vue&type=script&lang=js&");
/* harmony import */ var _Poll_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Poll.vue?vue&type=style&index=0&lang=css& */ "./resources/js/Components/Poll.vue?vue&type=style&index=0&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  ...
  _Poll_vue_vue_type_template_id_0f0fdf0a___WEBPACK_IMPORTED_MODULE_0__.render,
  _Poll_vue_vue_type_template_id_0f0fdf0a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Components/Poll.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/Shared/DidYouKnowBox.vue":
/*!***********************************************!*\
  !*** ./resources/js/Shared/DidYouKnowBox.vue ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _DidYouKnowBox_vue_vue_type_template_id_58adc358___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DidYouKnowBox.vue?vue&type=template&id=58adc358& */ "./resources/js/Shared/DidYouKnowBox.vue?vue&type=template&id=58adc358&");
/* harmony import */ var _DidYouKnowBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DidYouKnowBox.vue?vue&type=script&lang=js& */ "./resources/js/Shared/DidYouKnowBox.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _DidYouKnowBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _DidYouKnowBox_vue_vue_type_template_id_58adc358___WEBPACK_IMPORTED_MODULE_0__.render,
  _DidYouKnowBox_vue_vue_type_template_id_58adc358___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/
ox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PostListBox.vue?vue&type=script&lang=js& */ "./resources/js/Shared/PostListBox.vue?vue&type=script&lang=js&");
/* harmony import */ var _PostListBox_vue_vue_type_style_index_0_id_b352cb3e_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PostListBox.vue?vue&type=style&index=0&id=b352cb3e&scoped=true&lang=css& */ "./resources/js/Shared/PostListBox.vue?vue&type=style&index=0&id=b352cb3e&scoped=true&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__.default)(
  _PostListBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _PostListBox_vue_vue_type_template_id_b352cb3e_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _PostListBox_vue_vue_type_template_id_b352cb3e_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "b352cb3e",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Shared/PostListBox.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/Shared/ServerStatusBox.vue":
/*!*************************************************!*\
  !*** ./resources/js/Shared/ServerStatusBox.vue ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ServerStatusBox_vue_vue_type_template_id_679550ca___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ServerStatusBox.vue?vue&type=template&id=679550ca& */ "./resources/js/Shared/ServerStatusBox.vue?vue&type=template&id=679550ca&");
/* harmony import */ var _ServerStatusBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ServerStatusBox.vue?vue&type=script&lang=js& */ "./resources/js/Shared/ServerStatusBox.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _ServerStatusBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _ServerStatusBox_vue_vue_type_template_id_679550ca___WEBPACK_IMPORTED_MODULE_0__.render,
  _ServerStatusBox_vue_vue_type_template_id_679550ca___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Shared/ServerStatusBox.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/Shared/ShoutBox.vue":
/*!******************************************!*\
  !*** ./resources/js/Shared/ShoutBox.vue ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ShoutBox_vue_vue_type_template_id_241c068e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ShoutBox.vue?vue&type=template&id=241c068e& */ "./resources/js/Shared/ShoutBox.vue?vue&type=template&id=241c068e&");
/* harmony import */ var _ShoutBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ShoutBox.vue?vue&type=script&lang=js& */ "./resources/js/Shared/ShoutBox.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _ShoutBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _ShoutBox_vue_vue_type_template_id_241c068e___WEBPACK_IMPORTED_MODULE_0__.render,
  _ShoutBox_vue_vue_type_template_id_241c068e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Shared/ShoutBox.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/Shared/SocialChannelBox.vue":
/*!**************************************************!*\
  !*** ./resources/js/Shared/SocialChannelBox.vue ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _SocialChannelBox_vue_vue_type_template_id_751647f1___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SocialChannelBox.vue?vue&type=template&id=751647f1& */ "./resources/js/Shared/SocialChannelBox.vue?vue&type=template&id=751647f1&");
/* harmony import */ var _SocialChannelBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SocialChannelBox.vue?vue&type=script&lang=js& */ "./resources/js/Shared/SocialChannelBox.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _SocialChannelBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _SocialChannelBox_vue_vue_type_template_id_751647f1___WEBPACK_IMPORTED_MODULE_0__.render,
  _SocialChannelBox_vue_vue_type_template_id_751647f1___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/Shared/SocialChannelBox.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/Shared/TopPlayersListBox.vue":
/*!***************************************************!*\
  !*** ./resources/js/Shared/TopPlayersListBox.vue ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _TopPlayersListBox_vue_vue_type_template_id_d357b178___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TopPlayersListBox.vue?vue&type=template&id=d357b178& */ "./resources/js/Shared/TopPlayersListBox.vue?vue&type=template&id=d357b178&");
/* harmony import */ var _TopPlayersListBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TopPlayersListBox.vue?vue&type=script&lang=js& */ "./resources/js/Shared/TopPlayersListBox.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _TopPlayersListBox_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _TopPlayersListBox_vue_vue_type_template_id_d357b178___WEBPACK_IMPORTED_MODULE_0__.render,
  _TopPlayersListBox_vue_vue_type_template_id_d357b178___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/
WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_TopPlayersListBox_vue_vue_type_template_id_d357b178___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./TopPlayersListBox.vue?vue&type=template&id=d357b178& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/TopPlayersListBox.vue?vue&type=template&id=d357b178&");


/***/ }),

/***/ "./resources/js/Shared/VotingSitesBox.vue?vue&type=template&id=5970ddc2&":
/*!*******************************************************************************!*\
  !*** ./resources/js/Shared/VotingSitesBox.vue?vue&type=template&id=5970ddc2& ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_VotingSitesBox_vue_vue_type_template_id_5970ddc2___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_VotingSitesBox_vue_vue_type_template_id_5970ddc2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_VotingSitesBox_vue_vue_type_template_id_5970ddc2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./VotingSitesBox.vue?vue&type=template&id=5970ddc2& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/VotingSitesBox.vue?vue&type=template&id=5970ddc2&");


/***/ }),

/***/ "./resources/js/Shared/WelcomeBox.vue?vue&type=template&id=139392e5&":
/*!***************************************************************************!*\
  !*** ./resources/js/Shared/WelcomeBox.vue?vue&type=template&id=139392e5& ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_WelcomeBox_vue_vue_type_template_id_139392e5___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_WelcomeBox_vue_vue_type_template_id_139392e5___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_WelcomeBox_vue_vue_type_template_id_139392e5___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./WelcomeBox.vue?vue&type=template&id=139392e5& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/WelcomeBox.vue?vue&type=template&id=139392e5&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Comments.vue?vue&type=template&id=0473b13f&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Comments.vue?vue&type=template&id=0473b13f& ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex flex-col" }, [
    _c("hr", { staticClass: "mt-0.5 dark:border-cool-gray-700" }),
    _vm._v(" "),
    _vm.loading || _vm.loadingMore
      ? _c("div", { staticClass: "flex p-4 justify-center" }, [
          _c(
            ...
            {
              staticClass:
                "animate-spin -ml-1 mr-3 h-5 w-5 text-light-blue-600 dark:text-light-blue-400",
              attrs: {
    ...
    _c(
        ...
        directives: [
          {
            ...
            value:
              !_vm.loadingMore &&
              !_vm.loading &&
              _vm.showLoadMoreCommentsButton,
            expression: "!loadingMore && !loading && showLoadMoreCommentsButton"
          }
        ],
      ...
      [
        _c(
          ...
          {
            staticClass:
              "text-sm text-gray-500 dark:text-gray-400 font-semibold focus:outline-none hover:underline",
    ...
    _vm._v(" "),
    !_vm.loading && _vm.comments
      ? _c(
          "div",
          { staticClass: "flex mt-3 flex-col space-y-2" },
          _vm._l(_vm.comments.data, function(comment) {
            return _c(
              "div",
              { key: comment.id, staticClass: "flex" },
              [
                _c(
                  "div",
                  {
                    staticClass:
                      "space-y-2 text-sm max-w-lg mx-2 order-2 items-start"
                  },
                  [
                    _c(
                      "div",
                      {
                        staticClass:
                          "px-4 py-2 flex flex-col rounded-2xl inline-block rounded-tl-lg bg-gray-100 text-gray-700 dark:bg-cool-gray-600 dark:bg-opacity-25 dark:text-gray-200",
                        class: {
                          "border border-gray-300 dark:border-gray-700":
                            _vm.$page.props.user &&
                            _vm.$page.props.user.id === comment.user_id
                        }
                      },
                      [
                        _c(
                          ...
                          [
                            _c(
                              ...
                              {
                                staticClass:
                                  "cursor-pointer font-semibold text-gray-800",
                                style: [
                                  comment.commentator.roles[0].color
                                    ? {
                                        color:
                                          comment.commentator.roles[0].color
                                      }
                              ...
                              [_vm._v(_vm._s(comment.commentator.name) + " ")]
                            ),
                            _vm._v(" "),
                            _c(
                              "span",
                              ...
                              [
                                _vm._v(
                                  "@" + _vm._s(comment.commentator.username)
                                )
                              ]
                            ),
                            _vm._v(" "),
                            _c(
                              "span",
                              {
                                ...
                                staticClass:
                                  "ml-1 text-gray-500 dark:text-gray-400 text-xs focus:outline-none",
                                attrs: {
                                  title: _vm.format(
                            ...
                            _vm._v(" "),
                            comment.commentator.verified_at
                              ? _c("icon", {
                                  directives: [
                                    { name: "tippy", rawName: "v-tippy" }
                                  ],
                                  staticClass:
                                    "mb-1 focus:outline-none h-5 w-5 fill-current inline text-light-blue-400",
                                  attrs: {
                              ...
                              : _vm._e(),
                            _vm._v(" "),
                            comment.commentator.is_staff
                              ? _c("icon", {
                                  directives: [
                                    { name: "tippy", rawName: "v-tippy" }
                                  ],
                                  staticClass:
                                    "mb-1 focus:outline-none h-5 w-5 fill-current inline text-pink-400",
                                  attrs: {
                        ...
                        _c("span", {
                          domProps: {
                            innerHTML: _vm._s(
                              _vm.purifyAndLinkifyText(comment.comment)
                            )
                          }
                        })
                      ],
                ...
                _vm._v(" "),
                _c("img", {
                  staticClass: "w-8 h-8 rounded-full order-1 mt-2",
                  attrs: {
                ...
                _vm._v(" "),
                _vm.$page.props.user && comment.permissions.delete
                  ? _c(
                      "inertia-link",
                      {
                        staticClass: "focus:outline-none order-3",
                        attrs: {
                          "preserve-scroll": true,
                          "preserve-state": false,
                          as: "button",
                          method: "delete",
                          href: _vm.route("post.comment.delete", [
                            _vm.post.id,
                            comment.id
                          ])
                        }
                      ...
                      [
                        _c("icon", {
                          staticClass:
                            "text-gray-200 hover:text-red-400 dark:text-gray-500 dark:hover:text-red-500 w-4 h-4",
                          attrs: { name: "trash" }
                        })
                      ],
                      1
    ...
    _vm.$page.props.user
      ? _c("div", { staticClass: "flex mt-1" }, [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "text-sm mx-2 order-2 flex-grow" }, [
            _c(
              "form",
              {
                on: {
              ...
              [
                _c("input", {
                  ...
                  ref: "comment",
                  staticClass:
                    "mt-1 border border-gray-100 bg-gray-100 dark:bg-cool-gray-900 focus:border-gray-300 dark:border-gray-800 dark:focus:border-gray-700 dark:text-gray-200 focus:ring-0 block w-full sm:text-sm rounded-full disabled:opacity-50",
                  attrs: {
            ...
            _vm._v(" "),
            _vm.bodyerror
              ? _c("span", { staticClass: "text-xs ml-2 text-red-500" }, [
                  _vm._v(_vm._s(_vm.bodyerror))
                ])
              : _vm._e()
          ])
        ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/LoadingButton.vue?vue&type=template&id=ed005f5a&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/LoadingButton.vue?vue&type=template&id=ed005f5a& ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    [
      _vm.loading
        ? _c(
            "svg",
            {
              staticClass: "animate-spin -ml-1 mr-3 h-5 w-5",
              attrs: {
                xmlns: "http://www.w3.org/2000/svg",
                fill: "none",
                viewBox: "0 0 24 24"
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Poll.vue?vue&type=template&id=0f0fdf0a&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Poll.vue?vue&type=template&id=0f0fdf0a& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "vue-poll" },
    [
      _c("h3", {
        staticClass: "qst dark:text-gray-300",
      ...
      _c(
        "div",
        { staticClass: "ans-cnt" },
        _vm._l(_vm.calcAnswers, function(a, index) {
          var _obj
          return _c(
            "div",
            {
              ...
              class:
                ((_obj = { ans: true }),
                (_obj[a.custom_class] = a.custom_class),
                _obj)
            },
            [
              !_vm.finalResults
                ? [
                    !_vm.visibleResults
                      ? _c(
                          ...
                          {
                            staticClass:
                              "hover:bg-light-blue-100 dark:hover:bg-cool-gray-900",
                            class: {
                          ...
                          [
                            _c("span", {
                              staticClass: "txt",
                              domProps: { innerHTML: _vm._s(a.text) }
                            })
                          ]
                        )
                      : _c(
                          ...
                          {
                            class: {
                              "ans-voted dark:text-gray-200": true,
                              selected: a.selected
                            }
                          },
                          [
                            a.percent
                              ? _c("span", {
                                  staticClass: "percent",
                                  domProps: { textContent: _vm._s(a.percent) }
                                })
                              : _vm._e(),
                            _vm._v(" "),
                            _c("span", {
                    ...
                    _vm._v(" "),
                    _c("span", {
                      staticClass: "bg bg-cool-gray-200 dark:bg-cool-gray-700",
                      style: { width: _vm.visibleResults ? a.percent : "0%" }
                    })
                  ]
                : [
                    _c(
                      ...
                      {
                        class: {
                          "ans-voted final dark:text-gray-200": true,
                          selected: a.selected
                        }
                      },
                      [
                    ...
                    _c("span", {
                      class: {
                        "bg bg-cool-gray-200 dark:bg-cool-gray-700": true,
                        "bg-light-blue-300 dark:bg-light-blue-500":
                          _vm.mostVotes == a.votes
                      },
      ...
      _vm._v(" "),
      _vm.isComingSoon
        ? _c("div", { staticClass: "text-gray-400 text-xs italic" }, [
            _vm._v(
              "\n    Poll starting " +
                _vm._s(
                  _vm.formatDistanceToNowStrict(new Date(_vm.started_at), {
                    addSuffix: true
                  })
                ) +
                "\n  "
      ...
      _c("div", { staticClass: "flex justify-between items-baseline" }, [
        _vm.showTotalVotes && (_vm.visibleResults || _vm.finalResults)
          ? _c("div", {
              staticClass: "votes",
              domProps: {
                textContent: _vm._s(_vm.totalVotesFormatted + " votes")
              }
            })
          : _vm._e(),
        _vm._v(" "),
        !_vm.isComingSoon && _vm.closed_at && !_vm.finalResults
          ? _c("div", { staticClass: "text-gray-400 text-xs italic" }, [
              _vm._v(
                "\n      Poll closing " +
                  _vm._s(
                    _vm.formatDistanceToNowStrict(new Date(_vm.closed_at), {
                      addSuffix: true
                    })
                  ) +
                  "\n    "
        ...
        ? [
            _c("a", {
              ...
              on: {
                click: function($event) {
                  $event.preventDefault()
                  return _vm.handleMultiple.apply(null, arguments)
                }
              }
            })
          ]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Post.vue?vue&type=template&id=1b72876b&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Components/Post.vue?vue&type=template&id=1b72876b& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "px-5 py-4 bg-white dark:bg-cool-gray-800 shadow rounded",
      class: {
        "rounded-l-none border-l-4 border-light-blue-500":
          _vm.$page.props.user && _vm.$page.props.user.id === _vm.post.user.id
      }
    },
    [
      _c(
        ...
        [
              ...
              [
                _c(
                  "inertia-link",
                  {
                    ...
                    attrs: {
                      as: "div",
                      href: _vm.route("user.public.get", _vm.post.user.username)
                    }
                  },
                  [
                    _c(
                      ...
                      {
                        staticClass:
                          "text-black font-bold leading-snug text-black dark:text-gray-100",
                        style: [
                          _vm.post.user.roles[0].color
                            ? { color: _vm.post.user.roles[0].color }
                            : null
                        ]
                      },
                      [
                    ...
                    _vm._v(" "),
                    _vm.post.user.verified_at
                      ? _c("icon", {
                          directives: [{ name: "tippy", rawName: "v-tippy" }],
                          staticClass:
                            "mb-1 focus:outline-none h-6 w-6 fill-current inline text-light-blue-400",
                          attrs: {
                            name: "verified-check-fill",
                            title: "Verified Account"
                          }
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.post.user.is_staff
                      ? _c("icon", {
                          directives: [{ name: "tippy", rawName: "v-tippy" }],
                          staticClass:
                            "mb-1 focus:outline-none h-6 w-6 fill-current inline text-pink-400",
                          attrs: {
                            name: "shield-check-fill",
                            title: "Staff Member"
                          }
                  ...
                  [
                    _c(
                      "inertia-link",
                      {
                        directives: [{ name: "tippy", rawName: "v-tippy" }],
                        staticClass:
                          "focus:outline-none hover:text-light-blue-500 text-sm text-gray-500 dark:text-gray-300 font-light leading-snug",
                        attrs: {
                          as: "a",
                          href: _vm.route("post.show", _vm.post.id),
                          content: _vm.format(
                            new Date(_vm.post.created_at),
                            "E, do MMM yyyy, h:mm aaa"
                          )
                        }
                      },
          ...
          _vm._v(" "),
          _vm.$page.props.user && _vm.post.permissions.delete
            ? _c(
                "inertia-link",
                {
                  directives: [{ name: "tippy", rawName: "v-tippy" }],
                  staticClass:
                    "text-gray-500 hover:text-red-500 rounded-full flex items-start focus:outline-none",
                  attrs: {
                    content: "Delete Post",
                    "preserve-scroll": true,
                    "preserve-state": false,
                    as: "button",
                    method: "delete",
                    href: _vm.route("post.delete", _vm.post.id)
                  }
                },
                [
                  _c("icon", {
                    staticClass: "h-6 w-6 p-0.5",
                    attrs: { name: "trash" }
                  })
                ],
                1
      ...
      _c("p", {
        staticClass:
          "text-gray-800 dark:text-gray-200 mt-2 leading-snug md:leading-normal whitespace-pre-line break-words",
        domProps: { innerHTML: _vm._s(_vm.purifyAndLinkifyText(_vm.post.body)) }
      }),
      _vm._v(" "),
      _vm.post.media_url_array.length
        ? _c(
            "div",
            {
              staticClass: "grid gap-2",
              class: { "grid-cols-2": _vm.post.media_url_array.length > 1 }
            },
            _vm._l(_vm.post.media_url_array, function(url) {
              return _c("div", { staticClass: "relative" }, [
                _c("img", {
                  staticClass: "object-cover rounded-xl h-full w-full",
                  class:
                    _vm.post.media_url_array.length > 1
                      ? "max-h-56"
                      : "max-h-96",
                  attrs: { src: url, alt: "Attachment" }
                })
              ])
            }),
            0
      ...
      _c(
        ...
        {
          staticClass:
            "flex space-x-10 justify-end items-center mt-5 text-gray-500"
        },
        [
          !_vm.liked
            ? _c(
                "button",
                {
                  staticClass: "flex group cursor-pointer focus:outline-none",
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "group-hover:bg-pink-100 dark:group-hover:bg-cool-gray-900 group-hover:text-pink-500 p-1.5 rounded-full transition duration-300 ease-in-out"
                    },
                    [
                      _c("icon", {
                        staticClass: "h-6 w-6 p-0.5",
                        attrs: { name: "heart-hollow" }
                      })
                    ],
                    1
                  ),
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "text-gray-500 dark:text-gray-400  font-light py-1.5 group-hover:text-pink-500 transition duration-300 ease-in-out"
                    },
            ...
            : _c(
                ...
                {
                  staticClass:
                    "flex text-pink-500 group cursor-pointer focus:outline-none",
                  on: { click: _vm.unlikePost }
                },
                [
                  _c(
                    "span",
                    ...
                    [
                      _c("icon", {
                        staticClass: "w-6 h-6 p-0.5",
                        attrs: { name: "heart-fill" }
                      })
                    ],
                    1
                  ),
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "text-pink-500 dark:text-gray-400 font-light py-1.5 group-hover:text-pink-500 transition duration-300 ease-in-out"
                    },
                    [_vm._v(_vm._s(_vm.likes_count))]
                  )
                ]
          ...
          _c(
            ...
            [
              _c(
                ...
                {
                  staticClass:
                    "group-hover:bg-light-blue-100 dark:group-hover:bg-cool-gray-900 group-hover:text-light-blue-500 p-1.5 rounded-full transition duration-300 ease-in-out"
                },
                [
                  _c("icon", {
                    staticClass: "h-6 w-6 p-0.5",
              ...
              _c(
                ...
                {
                  staticClass:
                    "text-gray-500 dark:text-gray-400 font-light py-1.5 flex items-center group-hover:text-light-blue-500 transition duration-300 ease-in-out"
                },
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        {
          staticClass:
            "grid gap-4 grid-cols-none md:grid-cols-4 md:gap-6 py-4 px-2 md:py-12 md:px-10 md:px-6 lg:px-16"
        },
        [
          _c(
            "div",
            { staticClass: "col-span-1 space-y-4 order-1 md:order-none" },
            [
              _vm.generalSettings.enable_mcserver_onlineplayersbox
                ? _c("online-players-box")
                : _vm._e(),
              _vm._v(" "),
              _c("voting-sites-box", {
                attrs: {
                  votingsites: _vm.generalSettings.voteforserverbox_content,
                  enabled: _vm.generalSettings.enable_voteforserverbox
                }
              }),
              _vm._v(" "),
              _c("poll-box", { attrs: { poll: _vm.latestPoll } }),
              _vm._v(" "),
              _c("did-you-know-box", {
                attrs: { enabled: _vm.generalSettings.enable_didyouknowbox }
              }),
              _vm._v(" "),
              _c("discord-server-box", {
                attrs: {
                  enabled: _vm.generalSettings.enable_discordbox,
                  server: _vm.generalSettings.discord_server_id
                }
              }),
              _vm._v(" "),
              _c("donation-box")
          ...
          _c(
            ...
            {
              staticClass:
                "col-span-1 md:col-span-2 space-y-4 order-3 md:order-none"
            },
            [
              _vm.generalSettings.enable_welcomebox
                ? _c("welcome-box", {
                    attrs: { "html-data": _vm.welcomeBoxContentHtml }
                  })
                : _vm._e(),
              _vm._v(" "),
              _c("ingame-chat-box", {
                attrs: {
                  "default-server-id": _vm.chatDefaultServerId,
                  "server-list": _vm.chatServerList
                }
              }),
              _vm._v(" "),
              _c("top-players-list-box", {
                attrs: {
                  enabled: true,
                  players: _vm.top10Players,
                  title: "Top 10 Players"
                }
              }),
              _vm._v(" "),
              _c("latest-pinned-news", {
                attrs: { newslist: _vm.pinnedNewsList }
              }),
              _vm._v(" "),
              _vm.generalSettings.enable_status_feed
                ? _c("post-list-box")
                : _vm._e()
            ],
            1
          ...
          _c(
            "div",
            { staticClass: "col-span-1 space-y-4 order-2 md:order-none" },
            [
              _c("server-status-box"),
              _vm._v(" "),
              _c("shout-box"),
              _vm._v(" "),
              _c("news-box", { attrs: { newslist: _vm.newslist } }),
              _vm._v(" "),
              _c("online-users-box", {
                attrs: {
                  users: _vm.onlineUsers,
                  enabled: _vm.generalSettings.enable_onlineuserbox
                }
              }),
              _vm._v(" "),
              _c("newest-user-box", {
                attrs: {
                  user: _vm.newestUser,
                  enabled: _vm.generalSettings.enable_newuserbox
                }
              }),
              _vm._v(" "),
              _c("social-channel-box", {
                attrs: {
                  enabled: _vm.generalSettings.enable_socialbox,
                  "show-title": true,
                  twitter: _vm.generalSettings.twitter_url,
                  twitch: _vm.generalSettings.twitch_url,
                  youtube: _vm.generalSettings.youtube_url,
                  facebook: _vm.generalSettings.facebook_url
                }
              })
            ],
            1
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DidYouKnowBox.vue?vue&type=template&id=58adc358&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DidYouKnowBox.vue?vue&type=template&id=58adc358& ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _vm.enabled
    ? _c("div", { ref: "box" }, [
        _c(
          ...
          {
            staticClass:
              "p-3 sm:px-5 bg-white dark:bg-cool-gray-800 rounded shadow"
          },
          [
            _c(
              "h3",
              {
                staticClass: "font-extrabold text-gray-800 dark:text-gray-200"
              },
              [_vm._v("\n      Did You Know?\n    ")]
            ),
            _vm._v(" "),
            _vm.loading
              ? _c("div", { staticClass: "space-y-4 mt-4" }, [_vm._m(0)])
              : _vm._e(),
            _vm._v(" "),
            !_vm.loading
              ? _c("div", { staticClass: "flex space-x-2 mt-4" }, [
                  _vm.imageUrl
                    ? _c("img", {
                  ...
                  _c(
                    "div",
                    { staticClass: "text-gray-600 dark:text-gray-300 text-sm" },
                    [_vm._v("\n        " + _vm._s(_vm.text) + "\n      ")]
                  )
                ])
              : _vm._e()
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "max-w-sm w-full mx-auto" }, [
      _c("div", { staticClass: "animate-pulse flex space-x-4" }, [
        _c("div", {
          staticClass: "rounded bg-gray-300 dark:bg-cool-gray-700 h-8 w-8"
        }),
        _vm._v(" "),
        _c("div", { staticClass: "flex-1 space-y-1 py-1" }, [
          _c("div", {
            staticClass: "h-4 bg-gray-300 dark:bg-cool-gray-700 rounded w-3/4"
          }),
          _vm._v(" "),
          _c("div", {
            staticClass: "h-4 bg-gray-300 dark:bg-cool-gray-700 rounded w-5/6"
          })
        ])
      ])
    ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DiscordServerBox.vue?vue&type=template&id=10bd31d0&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DiscordServerBox.vue?vue&type=template&id=10bd31d0& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DonationBox.vue?vue&type=template&id=8e9b44a6&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/DonationBox.vue?vue&type=template&id=8e9b44a6& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        _c(
          ...
          [
            ...
            _c(
              ...
              {
                staticClass:
                  "rounded text-sm text-gray-600 dark:text-gray-300 text-center p-1"
              },
              [_vm._v("\n      " + _vm._s(_vm.donationText) + "\n    ")]
            ),
            _vm._v(" "),
            _c(
              "div",
              { staticClass: "mt-3 text-light-blue-400 flex justify-center" },
              [
                _c(
                  "a",
                  {
                    staticClass:
                      "hover:bg-light-blue-50 dark:hover:bg-cool-gray-900 border px-2 py-1 border-light-blue-400 font-semibold rounded",
                    attrs: {
                      target: "_blank",
                      href: _vm.$page.props.generalSettings.donation_box_url
                    }
                  },
                  [_vm._v("\n        Donate Now\n      ")]
                )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/IngameChatBox.vue?vue&type=template&id=4217c5e0&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/IngameChatBox.vue?vue&type=template&id=4217c5e0& ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _vm.enabled
    ? _c(
        ...
        [
          _c(
            ...
            [
              _c("div", { staticClass: "flex justify-between" }, [
                ...
                _vm._v(" "),
                _vm.serverList && _vm.serverList.length > 1
                  ? _c(
                      "select",
                      {
                        directives: [
                        ...
                        staticClass:
                          "text-xs border-gray-300 focus:border-light-blue-300 focus:ring focus:ring-light-blue-200 focus:ring-opacity-50 rounded-md shadow-sm",
                        attrs: {
                          id: "serverSelector",
                        ...
                        on: {
                          change: function($event) {
                            ...
                            _vm.serverId = $event.target.multiple
                              ? $$selectedVal
                              : $$selectedVal[0]
                          }
                        }
                      },
                      _vm._l(_vm.serverList, function(server) {
                        return _c(
                          "option",
                          { key: server.id, domProps: { value: server.id } },
                          [
                            _vm._v(
                              "\n          " +
                                _vm._s(server.name) +
              ...
              _c("div", { staticClass: "flex flex-col" }, [
                ...
                _c(
                  "div",
                  {
                    ...
                    staticClass:
                      "flex-col-reverse md:flex-row flex bg-cool-gray-900 dark:bg-cool-gray-900 rounded mt-1 p-1 text-white relative justify-between",
                  ...
                  [
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: !_vm.shouldDisplayPlayerList,
                            expression: "!shouldDisplayPlayerList"
                          }
                        ],
                        staticClass:
                          "text-green-400 font-semibold absolute mt-1 mr-2 right-0 top-0",
                        attrs: { type: "button" },
                        on: {
                          click: function($event) {
                            _vm.shouldDisplayPlayerList = !_vm.shouldDisplayPlayerList
                          }
                        }
                      },
                      [_vm._v("\n          [+]\n        ")]
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "flex  flex-col max-h-96 overflow-auto hide-scrollbar text-sm",
                        attrs: { id: "chatbox" }
                      },
                      [
                        _vm._l(_vm.chatLogs, function(chat) {
                          return _c("p", {
                            directives: [{ name: "tippy", rawName: "v-tippy" }],
                            key: chat.id,
                            staticClass: "focus:outline-none",
                            ...
                            domProps: { innerHTML: _vm._s(chat.data) }
                          })
                        }),
                        _vm._v(" "),
                        !_vm.chatLogs || _vm.chatLogs.length <= 0
                          ? _c(
                              "div",
                              {
                                staticClass:
                                  "flex italic text-sm w-full h-full items-center justify-center text-gray-500"
                              },
                              [
                                _vm._v(
                        ...
                        directives: [
                          {
                            ...
                            rawName: "v-show",
                            value:
                              !_vm.playersListLoading &&
                              _vm.shouldDisplayPlayerList,
                            expression:
                              "!playersListLoading && shouldDisplayPlayerList"
                          }
                        ],
                        staticClass:
                          "text-sm sticky flex justify-end bg-cool-gray-800 bg-opacity-100 rounded max-h-96 min-w-max overflow-auto hide-scrollbar",
                        attrs: { id: "player-list" }
                      },
                      [
                        _c(
                          "div",
                          { staticClass: "flex flex-col w-full space-y-1" },
                          [
                            _c(
                              "div",
                              {
                                staticClass:
                                  "flex bg-cool-gray-600 bg-opacity-25 p-2 items-center justify-center relative"
                              },
                              [
                                _c(
                                  "h3",
                                  { staticClass: "font-bold mr-5 ml-4" },
                                  [
                                    _vm._v(
                                      "\n                Players (" +
                                        _vm._s(_vm.playersList.length) +
                                        ")\n              "
                                    )
                                  ]
                                ),
                                ...
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "text-red-400 font-semibold absolute mr-2 right-0",
                                    attrs: { type: "button" },
                                    on: {
                                      click: function($event) {
                                        _vm.shouldDisplayPlayerList = !_vm.shouldDisplayPlayerList
                            ...
                            _vm._l(_vm.playersList, function(player) {
                              return _c(
                                "div",
                                { staticClass: "flex justify-between mx-1" },
                                [
                                  _c(
                                    "div",
                                    { staticClass: "flex space-x-1 truncate" },
                                    [
                                      _c("img", {
                                        staticClass: "h-5",
                                        attrs: {
                                          src: _vm.route("player.avatar.get", {
                                            uuid: player.id,
                                            size: 50
                                          }),
                                          alt: "Player Avatar"
                                      ...
                                      player.is_in_db
                                        ...
                                        : _c(
                                            "span",
                                            {
                                              staticClass: "truncate mr-1",
                                              class: {
                                                "text-yellow-300": player.is_op
                                              }
                                            },
                                            [
                                              _vm._v(
                                        ...
                                        ? _c(
                                            "a",
                                            {
                                              ...
                                              on: {
                                                click: function($event) {
                                                  $event.preventDefault()
                                                  return _vm.openAdminPlayerActionModel(
                                                    player
                                                  )
                                                }
                                              }
                      ...
                      _c(
                        "form",
                        {
                          on: {
                            submit: function($event) {
                              $event.preventDefault()
                              return _vm.postSendMessage.apply(null, arguments)
                            }
                          }
                        },
                        [
                          !_vm.loading
                            ? _c("input", {
                                ...
                                ref: "inputbox",
                                staticClass:
                                  "mt-1 focus:ring-gray-300 dark:focus:ring-gray-700 block w-full sm:text-sm rounded-md border-none disabled:opacity-50 bg-gray-100 dark:bg-cool-gray-900 dark:text-gray-200 focus:bg-white",
                                attrs: {
                          ...
                          _vm.error
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          !_vm.loading && _vm.can("send server_custom_commands")
                            ? _c(
                                "span",
                                {
                                  staticClass:
                                    "flex mt-2 justify-end text-gray-500 dark:text-gray-400 text-xs"
                                },
                                [
                                  _vm._v(
                                    "Start with / to send a console command"
                                  )
                                ]
                              )
                            : _vm._e()
                  ...
                  : _c(
                      ...
                      [
                        _c(
                          "inertia-link",
                          {
                            staticClass: "font-semibold text-light-blue-500",
          ...
          _vm._v(" "),
          _c("jet-dialog-modal", {
            attrs: { show: _vm.showAdminPlayerActionModel },
            on: { close: _vm.closeAdminPlayerActionModel },
            scopedSlots: _vm._u(
              [
                {
                  key: "title",
                      ...
                      _vm.actionModelCurrentPlayer
                        ? _c(
                            ...
                            [
                              _c(
                                "span",
                                { staticClass: "underline text-gray-800" },
                                [_vm._v("Manage Player")]
                              ),
                              _vm._v(" "),
                              _c("img", {
                                staticClass: "h-24 rounded",
                                attrs: {
                                  src: _vm.route("player.avatar.get", {
                                    uuid: _vm.actionModelCurrentPlayer.id
                                  }),
                                  alt: "Player Avatar"
                                }
                              }),
                              ...
                              _c(
                                "span",
                                { staticClass: "text-light-blue-600" },
                                [
                                  _vm._v(
                                    _vm._s(
                                      _vm.actionModelCurrentPlayer.username
                                    )
                                  )
                                ]
                              ),
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm.actionModelCurrentPlayer.id)
                                  )
                                ]
                              )
                            ]
                  ...
                  fn: function() {
                    return [
                      _c(
                        ...
                        [
                          _vm.can("kill players")
                            ? _c(
                                "loading-button",
                                {
                                  staticClass:
                                    "inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50",
                                  attrs: {
                                    loading: _vm.adminPlayerActionLoading,
                                    type: "button"
                                  },
                                  nativeOn: {
                                    click: function($event) {
                                      return _vm.sendCommandToServer("kill")
                                    }
                                  }
                                },
                                [_vm._v("\n          Kill\n        ")]
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.can("mute players")
                            ? _c(
                                "loading-button",
                                {
                                  staticClass:
                                    "inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-200 disabled:opacity-50",
                                  attrs: {
                                    loading: _vm.adminPlayerActionLoading,
                                    type: "button"
                                  },
                                  nativeOn: {
                                    click: function($event) {
                                      return _vm.sendCommandToServer("mute")
                                    }
                                  }
                                },
                                [_vm._v("\n          Mute / Unmute\n        ")]
                            ...
                            : _vm._e(),
                          _vm._v(" "),
                          _vm.can("kick players")
                            ? _c(
                                "loading-button",
                                {
                                  staticClass:
                                    "inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 disabled:opacity-50",
                                  attrs: {
                                    loading: _vm.adminPlayerActionLoading,
                                    type: "button"
                                  },
                                  nativeOn: {
                                    click: function($event) {
                                      return _vm.sendCommandToServer("kick")
                                    }
                                  }
                                },
                                [_vm._v("\n          Kick\n        ")]
                          ...
                          _vm.can("ban players")
                            ? _c(
                                ...
                                {
                                  staticClass:
                                    "inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 disabled:opacity-50",
                                  attrs: {
                                    loading: _vm.adminPlayerActionLoading,
                                    type: "button"
                                  },
                                  nativeOn: {
                                    click: function($event) {
                                      return _vm.sendCommandToServer("ban")
                                    }
                                  }
                                },
                                [_vm._v("\n          Ban\n        ")]
                      ...
                      _vm._v(" "),
                      _vm.adminPlayerActionError
                        ? _c(
                            "div",
                            {
                              staticClass:
                                "flex text-red-500 border border-red-500 bg-red-100 p-1 mt-2 justify-center text-sm"
                            },
                            [
                              _vm._v(
                                "\n        " +
                                  _vm._s(_vm.adminPlayerActionError) +
                                  "\n      "
                              )
                            ]
                          )
                    ...
                    return [
                      _c(
                        "jet-secondary-button",
                        {
                          nativeOn: {
                            click: function($event) {
                              return _vm.closeAdminPlayerActionModel.apply(
                                null,
                                arguments
                              )
                            }
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/LatestPinnedNews.vue?vue&type=template&id=12e6f20e&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/LatestPinnedNews.vue?vue&type=template&id=12e6f20e& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.newslist && _vm.newslist.length > 0
    ? _c(
        "div",
        ...
        _vm._l(_vm.newslist, function(news) {
          return _c(
            ...
            {
              staticClass:
                "bg-white dark:bg-cool-gray-800 rounded shadow flex justify-between"
            },
            [
              _c("div", { staticClass: "p-3 sm:px-5" }, [
                _c(
                  "div",
                  { staticClass: "text-xl" },
                  [
                    _c(
                      ...
                      [
                        _c("icon", {
                          directives: [{ name: "tippy", rawName: "v-tippy" }],
                          staticClass:
                            "inline text-gray-400 focus:outline-none",
                          attrs: { content: "Pinned News", name: "paper-clip" }
                        }),
                        _vm._v(" "),
                        _c(
                          "span",
                          {
                            ...
                            class: {
                              "text-light-blue-400": news.type.value === 0,
                              "text-orange-500": news.type.value === 1,
                              "text-green-500": news.type.value === 2
                            }
                          },
                          [_vm._v(_vm._s(news.type.key))]
                        ),
                        _vm._v(" "),
                        _c(
                          "span",
                          {
                            directives: [{ name: "tippy", rawName: "v-tippy" }],
                            staticClass:
                              "focus:outline-none text-sm text-gray-500 dark:text-gray-400 font-light leading-snug",
                            attrs: {
                              content: _vm.format(
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "text-sm text-gray-500 dark:text-gray-400 font-light leading-snug"
                          },
                          [_vm._v(" - " + _vm._s(news.time_to_read) + " read")]
                        )
                      ],
                      1
                    ),
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "hover:text-light-blue-400 dark:text-gray-200 dark:hover:text-light-blue-400 duration-200",
                        attrs: { href: _vm.route("news.show", news.slug) }
                      },
                      [
                        _vm._v(
                          "\n          " + _vm._s(news.title) + "\n        "
                ...
                _vm._v(" "),
                _c("div", {
                  staticClass: "mt-3 text-gray-500 dark:text-gray-400",
                  domProps: { innerHTML: _vm._s(news.body_md) }
                })
              ]),
              _vm._v(" "),
              news.photo_url
                ? _c("img", {
                    staticClass: "h-auto w-2/5 object-cover object-center",
                    attrs: { src: news.photo_url, alt: "News Image" }
                  })
                : _vm._e()
            ]
          )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewestUserBox.vue?vue&type=template&id=2c59188e&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewestUserBox.vue?vue&type=template&id=2c59188e& ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.enabled && _vm.user
    ? _c("div", [
        _c(
          "div",
          {
            staticClass:
              "p-3 bg-white dark:bg-cool-gray-800 rounded shadow space-y-2"
          },
          [
            _c(
              "h3",
            ...
            _c(
              ...
              {
                staticClass:
                  "cursor-pointer flex space-x-2 border dark:border-gray-700 rounded-tl-md rounded-tr-xl rounded-b-3xl p-2 items-center hover:border-light-blue-400 dark:hover:border-light-blue-400",
                attrs: {
                  as: "div",
                  href: _vm.route("user.public.get", _vm.user.username)
                }
              },
              [
                _c("img", {
                  staticClass: "w-14 h-14 rounded-full",
                  attrs: { src: _vm.user.profile_photo_url, alt: "Avatar" }
                }),
                _vm._v(" "),
                _c("div", { staticClass: "flex flex-col" }, [
                  _c("div", [
                    _c(
                      "span",
                      {
                        ...
                        style: [
                          _vm.user.roles[0].color
                            ? { color: _vm.user.roles[0].color }
                            : null
                        ]
                      },
                  ...
                  _c(
                    "span",
                    {
                      directives: [{ name: "tippy", rawName: "v-tippy" }],
                      staticClass:
                        "text-sm text-gray-700 dark:text-gray-500 focus:outline-none",
                      attrs: {
                        content: _vm.format(
                          new Date(_vm.user.created_at),
                          "E, do MMM yyyy, h:mm aaa"
                        )
                      }
                    },
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewsBox.vue?vue&type=template&id=1437c568&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/NewsBox.vue?vue&type=template&id=1437c568& ***!
  \***************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.newslist.length > 0
    ? _c("div", [
        _c(
          "div",
          {
            staticClass:
              "p-3 bg-white dark:bg-cool-gray-800 rounded shadow space-y-4"
          },
          [
            _c(
              "h3",
            ...
            _vm._l(_vm.newslist, function(news) {
              return _c(
                "div",
                { key: news.id, staticClass: "flex justify-between space-y-4" },
                [
                  _c("div", { staticClass: "flex-co space-y-1" }, [
                    news.type.value === 0
                      ? _c(
                          "span",
                          {
                            staticClass:
                              "px-2 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-lg bg-light-blue-100 text-light-blue-800 dark:bg-light-blue-700 dark:bg-opacity-25 dark:text-light-blue-400"
                          },
                          [_vm._v(_vm._s(news.type.key))]
                        )
                      : news.type.value === 1
                      ? _c(
                          ...
                          {
                            staticClass:
                              "px-2 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-lg bg-orange-100 text-orange-800 dark:bg-orange-700 dark:bg-opacity-25 dark:text-orange-400"
                          },
                          [_vm._v(_vm._s(news.type.key))]
                        )
                      : news.type.value === 2
                      ? _c(
                          ...
                          {
                            staticClass:
                              "px-2 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-lg bg-green-100 text-green-800 dark:bg-green-700 dark:bg-opacity-25 dark:text-green-400"
                          },
                          [_vm._v(_vm._s(news.type.key))]
                        )
                      : _c(
                          ...
                          {
                            staticClass:
                              "px-2 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-lg bg-gray-100 text-gray-800 dark:bg-gray-700 dark:bg-opacity-25 dark:text-gray-400"
                          },
                          [_vm._v(_vm._s(news.type.key))]
                        ),
                    _vm._v(" "),
                    _c(
                      ...
                      {
                        staticClass:
                          "font-semibold leading-5 text-gray-800 dark:text-gray-300"
                      },
                      [
                        _c(
                          "inertia-link",
                          {
                            staticClass:
                              "hover:text-light-blue-400 duration-200",
                            attrs: { href: _vm.route("news.show", news.slug) }
                          },
                    ...
                    _c(
                      "span",
                      {
                        directives: [{ name: "tippy", rawName: "v-tippy" }],
                        staticClass:
                          "text-gray-500 dark:text-gray-400 text-xs focus:outline-none",
                        attrs: {
                          title: _vm.format(
                            new Date(news.published_at),
                            "E, do MMM yyyy, h:mm aaa"
                    ...
                    _c(
                      "span",
                      {
                        staticClass: "text-gray-500 dark:text-gray-400 text-xs"
                      },
                      [_vm._v(" - " + _vm._s(news.time_to_read) + " read")]
                    )
                  ]),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlinePlayersBox.vue?vue&type=template&id=519dc4c8&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlinePlayersBox.vue?vue&type=template&id=519dc4c8& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _vm.enabled
    ? _c("div", [
        _c(
          "div",
          {
            staticClass: "p-3 sm:px-5 bg-white dark:bg-gray-800 rounded shadow"
          },
          [
            _c(
              "h3",
              ...
              [
                ...
                !_vm.loading && !_vm.error
                  ? _c(
                      "span",
                      {
                        staticClass: "float-right text-green-500 font-semibold"
                      },
                      [
                        _vm._v(
                          "\n        " +
                            _vm._s(_vm.serverInfo["Players"]) +
                            " / " +
                            _vm._s(_vm.serverInfo["MaxPlayers"]) +
                            "\n      "
                        )
                      ]
                    )
            ...
            !_vm.loading && !_vm.error
              ? _c(
                  ...
                  {
                    staticClass:
                      "mt-3 text-gray-500 flex flex-wrap justify-center"
                  },
                  _vm._l(_vm.playersList, function(uuid, username) {
                    return _c(
                      "div",
                      {
            ...
            !_vm.playersList || _vm.playersList.length <= 0
              ? _c(
                  "div",
                  {
                    staticClass: "italic p-1 rounded text-center text-gray-400"
                  },
                  [_vm._v("\n      No players online.\n    ")]
                )
              : _vm._e()
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlineUsersBox.vue?vue&type=template&id=5299c51c&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/OnlineUsersBox.vue?vue&type=template&id=5299c51c& ***!
  \**********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          [
            ...
            _vm.users && _vm.users.length > 0
              ? _c(
                  ...
                  _vm._l(_vm.onlineMembers, function(user) {
                    return _c(
                      "inertia-link",
                      {
                        key: user.id,
                        staticClass:
                          "cursor-pointer flex mr-2 items-center text-light-blue-500 hover:underline",
                        style: [
                          user.user.roles[0].color
                            ? { color: user.user.roles[0].color }
                            : null
                        ],
                        attrs: {
                          as: "div",
                          href: _vm.route("user.public.get", user.user.username)
                        }
                      },
                      [
                        _c("img", {
                          staticClass: "h-5 w-5 rounded-full mr-0.5",
                          attrs: {
                        ...
                        _vm._v(" "),
                        _c("span", [_vm._v("@" + _vm._s(user.user.username))])
                      ]
                    )
                  }),
                  1
              ...
              : _c(
                  ...
                  {
                    staticClass:
                      "text-gray-500 dark:text-gray-400 italic font-light flex justify-center"
                  },
                  [_vm._v("\n      No member online.\n    ")]
                ),
            _vm._v(" "),
            _c(
              ...
              {
                staticClass:
                  "flex justify-center text-xs text-gray-700 dark:text-gray-300 font-semibold"
              },
              [
                _vm._v(
                  "\n      Total: " +
                    _vm._s(_vm.guestCount + _vm.onlineMembers.length) +
                    " (members: " +
                    _vm._s(_vm.onlineMembers.length) +
                    ", guests: " +
                    _vm._s(_vm.guestCount) +
                    ")\n    "
                )
              ]
            )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PollBox.vue?vue&type=template&id=7472eee0&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PollBox.vue?vue&type=template&id=7472eee0& ***!
  \***************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          [
            ...
            _vm.isListing
              ? _c(
                  ...
                  [_vm._v("\n      Poll " + _vm._s(_vm.poll.id) + "\n    ")]
                )
              : _vm._e(),
            _vm._v(" "),
            _c(
              "div",
              { staticClass: "mt-3 text-gray-500 dark:text-gray-300" },
              [
                _c(
                  "poll",
                  _vm._b(
                    { on: { addvote: _vm.addVote } },
                    "poll",
                    _vm.options,
                    false
                  )
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PostListBox.vue?vue&type=template&id=b352cb3e&scoped=true&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/PostListBox.vue?vue&type=template&id=b352cb3e&scoped=true& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "space-y-4 w-full" },
    [
      _vm.$page.props.user && !_vm.username
        ? _c(
            "div",
            {
              staticClass:
            ...
            [
              _c(
                "form",
                {
                  staticClass: "mt-4 text-xl flex flex-col items-end space-y-2",
                  on: {
                    submit: function($event) {
                      $event.preventDefault()
                      return _vm.submitPost.apply(null, arguments)
                    }
                  }
                },
                [
                  _c("textarea", {
                    ...
                    ref: "post-content",
                    staticClass:
                      "mt-1 overflow-hidden block w-full shadow-sm sm:text-sm border-gray-300 rounded-md resize-none focus:border-light-blue-300 focus:ring text-sm focus:ring-light-blue-200 focus:ring-opacity-50 dark:bg-cool-gray-900 dark:text-gray-200 dark:border-gray-800",
                    attrs: {
                      "aria-label": "post content",
                      placeholder: _vm.bodyPlaceholderText,
                      name: "post",
                      rows: "3"
                    },
                  ...
                  _vm._v(" "),
                  _vm.imagesDisplay.length
                    ? _c(
                        "div",
                        { staticClass: "grid gap-1 grid-cols-3 w-full" },
                        _vm._l(_vm.imagesDisplay, function(img, index) {
                          return _c("div", { staticClass: "relative" }, [
                            _c(
                              "button",
                              {
                                staticClass:
                                  "m-1 absolute top-0 left-0 bg-black bg-opacity-75 rounded-full cursor-pointer hover:bg-opacity-100 text-white",
                                attrs: { type: "button" },
                                on: {
                                  click: function($event) {
                            ...
                            _vm._v(" "),
                            _c("img", {
                              staticClass: "object-cover rounded-xl h-48",
                              attrs: { src: img.url, alt: "Attachment" }
                            })
                          ])
                        }),
                        0
                  ...
                  _c(
                    ...
                    [
                      _c("input", {
                        ...
                        on: { change: _vm.handleImageChangeListener }
                      }),
                      _vm._v(" "),
                      _c(
                        "button",
                        {
                          directives: [{ name: "tippy", rawName: "v-tippy" }],
                          staticClass:
                            "inline-flex items-center justify-center h-10 w-10 hover:bg-light-blue-100 dark:hover:bg-cool-gray-900 rounded-full focus:outline-none",
                          attrs: { title: "Add Media", type: "button" },
                          on: { click: _vm.openImageSelector }
                        },
                        [
                          _c("icon", {
                            staticClass: "h-6 w-6 text-light-blue-400",
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-bold tracking-wide leading-5 rounded-full text-white bg-light-blue-500 hover:bg-light-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-blue-500 disabled:opacity-50",
                          attrs: { loading: _vm.postsubmitting, type: "submit" }
                        },
                        [_vm._v("\n          Post\n        ")]
                      )
                    ],
      ...
      _c(
        "infinite-scroll",
        { attrs: { "load-more": _vm.loadMorePosts } },
        [
          _c(
            "transition-group",
            { staticClass: "space-y-4", attrs: { name: "list", tag: "div" } },
            [
              _vm._l(_vm.posts.data, function(post) {
                return _c("post", { key: post.id, attrs: { post: post } })
              }),
              _vm._v(" "),
              !_vm.loading && _vm.showEmptyPost && _vm.posts.data.length <= 0
                ? _c(
                    "div",
                    {
                      key: 999999999,
                      staticClass:
                        "flex bg-white dark:bg-cool-gray-800 items-center justify-center italic text-gray-500 dark:text-gray-400 p-4 rounded shadow"
                    },
                    [
                      _vm._v(
                        "\n        " +
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "px-5 py-4 bg-white dark:bg-cool-gray-800 shadow rounded-lg"
      },
      [
        _c("div", { staticClass: "animate-pulse flex space-x-4" }, [
          _c("div", {
            staticClass:
              "rounded-full bg-gray-300 dark:bg-cool-gray-700 h-12 w-12"
          }),
          _vm._v(" "),
          _c("div", { staticClass: "flex-1 space-y-4 py-1" }, [
            ...
            _c("div", { staticClass: "space-y-2" }, [
              _c("div", {
                staticClass: "h-4 bg-gray-300 dark:bg-cool-gray-700 rounded"
              }),
              _vm._v(" "),
              _c("div", {
                staticClass:
                  "h-4 bg-gray-300 dark:bg-cool-gray-700 rounded w-5/6"
              })
            ])
          ])
        ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ServerStatusBox.vue?vue&type=template&id=679550ca&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ServerStatusBox.vue?vue&type=template&id=679550ca& ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _vm.enabled
    ? _c("div", [
        _c(
          ...
          {
            staticClass:
              "p-3 sm:px-5 bg-white dark:bg-cool-gray-800 rounded shadow break-words"
          },
          [
            _c(
              "h3",
              ...
              ? _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        staticClass:
                          "mt-3 text-gray-700 dark:text-gray-300 text-center font-semibold"
                      },
                      [
                        _vm._v("\n        Join "),
                        _c(
                          ...
                          {
                            staticClass:
                              "font-bold text-light-blue-500 dark:text-light-blue-400"
                          },
                          [_vm._v(_vm._s(_vm.serverInfo.players.online))]
                        ),
                        _vm._v(" Online\n        Players!\n      ")
                      ]
                    ),
                                    ...
                                    on: {
                                      click: function($event) {
                                        return props.copy(
                                          _vm.server
                                            ? _vm.server.hostname
                                            : _vm.$page.props.defaultQueryServer
                                                .hostname
                                        )
                                      }
                                    }
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ShoutBox.vue?vue&type=template&id=241c068e&":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/ShoutBox.vue?vue&type=template&id=241c068e& ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _c("div", [
    _c(
      ...
      [
        _c(
          "h3",
          { staticClass: "text-gray-800 font-extrabold dark:text-gray-200" },
          [_vm._v("\n      Shout Box\n    ")]
        ),
        _vm._v(" "),
        _c(
          ...
          {
            staticClass:
              "flex-col space-y-4 max-h-96 overflow-auto hide-scrollbar"
          },
          [
            _vm.loading
              ? _c("div", { staticClass: "space-y-4" }, [
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm._l(_vm.shouts, function(shout) {
              return _c("div", { key: shout.id, staticClass: "chat-message" }, [
                !_vm.$page.props.user ||
                shout.user_id !== _vm.$page.props.user.id
                  ? _c(
                      "div",
                      { staticClass: "flex" },
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "space-y-2 text-sm max-w-xs mx-2 order-2 items-start"
                          },
                          [
                            _c(
                              "div",
                                  ...
                                  [
                                    _c(
                                      "inertia-link",
                                      {
                                        ...
                                        style: [
                                          shout.user.roles[0].color
                                            ? {
                                                color: shout.user.roles[0].color
                                              }
                                            : null
                                        ],
                                        attrs: {
                        ...
                        _vm._v(" "),
                        _vm.$page.props.user && shout.permissions.delete
                          ? _c(
                              "inertia-link",
                              {
                                staticClass: "focus:outline-none order-3",
                                attrs: {
                                  ...
                                  as: "button",
                                  method: "delete",
                                  href: _vm.route("shout.delete", shout.id)
                                }
                              },
                              [
                                _c("icon", {
                                  staticClass:
                                    "text-gray-200 dark:text-gray-500 w-4 h-4 hover:text-red-400 dark:hover:text-red-500",
                                  attrs: { name: "trash" }
                                })
                              ],
                              1
                  ...
                  : _c(
                      ...
                      [
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "space-y-2 text-sm max-w-xs mx-2 order-1 items-start"
                          },
                          [
                            _c(
                              "div",
                              {
                                staticClass:
                                  "px-4 py-2 flex flex-col rounded-2xl inline-block rounded-tr-lg bg-light-blue-100 text-gray-700 dark:bg-cool-gray-900 dark:bg-opacity-40 dark:text-gray-200"
                              },
                              [
                                _c(
                                  "div",
                                  ...
                                  [
                                    _c(
                                      "span",
                                      {
                                        ...
                                        staticClass:
                                          "mr-1 text-gray-500 dark:text-gray-400 text-xs focus:outline-none",
                                        attrs: {
                                          title: _vm.format(
                                            new Date(shout.created_at),
                                            "E, do MMM yyyy, h:mm aaa"
                        ...
                        _vm._v(" "),
                        _c("img", {
                          staticClass: "w-8 h-8 rounded-full order-2 mt-2",
                          attrs: {
                            src: shout.user.profile_photo_url,
                            alt: "My profile"
                          }
          ...
          ? _c("div", [
              !_vm.loading
                ? _c("input", {
                    ...
                    ref: "inputbox",
                    staticClass:
                      "mt-1 focus:ring-gray-300 block w-full sm:text-sm rounded-md border-none disabled:opacity-50 bg-gray-100 focus:bg-white dark:bg-cool-gray-900 dark:text-gray-200 dark:focus:ring-gray-700",
                    attrs: {
                      disabled: _vm.sending,
                      "aria-label": "Shout",
                      type: "text",
                    ...
                    on: {
                      keypress: function($event) {
                        ...
                        return _vm.sendShout.apply(null, arguments)
                      },
                      input: function($event) {
                        if ($event.target.composing) {
                          return
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "max-w-sm w-full mx-auto" }, [
      _c("div", { staticClass: "animate-pulse flex space-x-4" }, [
        _c("div", {
          staticClass: "rounded-full bg-gray-300 dark:bg-cool-gray-700 h-8 w-8"
        }),
        _vm._v(" "),
        _c("div", { staticClass: "flex-1 space-y-1 py-1" }, [
          _c("div", {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/SocialChannelBox.vue?vue&type=template&id=751647f1&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/SocialChannelBox.vue?vue&type=template&id=751647f1& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        [
          _vm.showTitle
            ? _c(
                "h3",
                {
                  staticClass: "text-gray-800 dark:text-gray-200 font-extrabold"
                },
                [_vm._v("\n    Socials\n  ")]
              )
            : _vm._e(),
          ...
          _c(
            "div",
            { staticClass: "flex items-center justify-center space-x-6" },
            [
              _vm.youtube
                ? _c(
                    "a",
                    {
                      directives: [{ name: "tippy", rawName: "v-tippy" }],
                      staticClass:
                        "inline-block p-1 hover:bg-red-600 text-gray-700 rounded hover:text-white transition duration-100 ease-in dark:text-gray-300 dark:hover:text-white",
                      attrs: {
                        title: "Youtube",
                        href: _vm.youtube,
                        target: "_blank"
                    ...
                    [
                      _c(
                        "svg",
                        {
                          staticClass: "fill-current h-8 w-8 p-1",
                          attrs: {
                            height: "512",
                            viewBox: "0 0 24 24",
                            width: "512",
                        ...
                        [
                          _c("path", {
                            attrs: {
                              d:
                                "M9.939 7.856a.75.75 0 00-1.134.644v7c0 .585.638.939 1.134.645l5.869-3.495a.751.751 0 00.001-1.289zm.366 6.325v-4.36l3.655 2.183z"
                            }
                          }),
                          _vm._v(" "),
                          _c("path", {
              ...
              _vm.twitter
                ? _c(
                    "a",
                    {
                      directives: [{ name: "tippy", rawName: "v-tippy" }],
                      staticClass:
                        "inline-block p-1 hover:bg-light-blue-600 text-gray-700 rounded hover:text-white transition duration-100 ease-in dark:text-gray-300 dark:hover:text-white",
                      attrs: {
                        title: "Twitter",
                        href: _vm.twitter,
                        target: "_blank"
                    ...
                    [
                      _c("icon", {
                        staticClass: "h-8 w-8 p-1 fill-current",
                        attrs: { name: "twitter" }
                      })
                    ],
                    1
              ...
              _vm.twitch
                ? _c(
                    "a",
                    {
                      directives: [{ name: "tippy", rawName: "v-tippy" }],
                      staticClass:
                        "inline-block p-1 hover:bg-purple-600 text-gray-700 rounded hover:text-white transition duration-100 ease-in dark:text-gray-300 dark:hover:text-white",
                      attrs: {
                        title: "Twitch",
                        href: _vm.twitch,
                        target: "_blank"
                      ...
                      _c(
                        ...
                        [
                          _c("path", {
                            attrs: {
                              d:
                                "M.975 4.175v16.694h5.749V24h3.139l3.134-3.132h4.705l6.274-6.258V0H2.542zm3.658-2.09h17.252v11.479l-3.66 3.652h-5.751L9.34 20.343v-3.127H4.633z"
                            }
                          }),
                          _vm._v(" "),
                          _c("path", {
                            attrs: {
                              d:
                                "M10.385 6.262h2.09v6.26h-2.09zM16.133 6.262h2.091v6.26h-2.091z"
                            }
                          })
                        ]
                      )
              ...
              _vm.facebook
                ? _c(
                    "a",
                    {
                      directives: [{ name: "tippy", rawName: "v-tippy" }],
                      staticClass:
                        "inline-block p-1 hover:bg-blue-700 text-gray-700 rounded hover:text-white transition duration-100 ease-in dark:text-gray-300 dark:hover:text-white",
                      attrs: {
                        title: "Facebook",
                        href: _vm.facebook,
                        target: "_blank"
                    ...
                    [
                      _c(
                        "svg",
                        {
                          staticClass: "w-8 h-8 p-1 fill-current",
                          attrs: {
                            xmlns: "http://www.w3.org/2000/svg",
                        ...
                        [
                          _c("path", {
                            attrs: {
                              d:
                                "M89.584 155.139V84.378h23.742l3.562-27.585H89.584V39.184c0-7.984 2.208-13.425 13.67-13.425l14.595-.006V1.08C115.325.752 106.661 0 96.577 0 75.52 0 61.104 12.853 61.104 36.452v20.341H37.29v27.585h23.814v70.761h28.48z"
                            }
                          })
                        ]
                      )
              ...
              _vm.steam
                ? _c(
                    "a",
                    {
                      directives: [{ name: "tippy", rawName: "v-tippy" }],
                      staticClass:
                        "inline-block p-1 hover:bg-gray-800 text-gray-700 rounded hover:text-white transition duration-100 ease-in dark:text-gray-300 dark:hover:text-white",
                      attrs: {
                        title: "Steam",
                        href: _vm.steam,
                        target: "_blank"
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("path", {
                            attrs: {
                              d:
                                "M17.92 4.556c-1.805 0-3.267 1.457-3.267 3.255s1.457 3.255 3.267 3.255c1.794 0 3.267-1.452 3.267-3.255s-1.473-3.255-3.267-3.255z"
                            }
                          })
                        ]
                      )
              ...
              _vm.website
                ? _c(
                    "a",
                    {
                      directives: [{ name: "tippy", rawName: "v-tippy" }],
                      staticClass:
                        "inline-block p-1 hover:bg-green-600 text-gray-700 rounded hover:text-white transition duration-100 ease-in dark:text-gray-300 dark:hover:text-white",
                      attrs: {
                        title: "Website",
                        href: _vm.website,
                        target: "_blank"
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/TopPlayersListBox.vue?vue&type=template&id=d357b178&":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/TopPlayersListBox.vue?vue&type=template&id=d357b178& ***!
  \*************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.enabled && _vm.players && _vm.players.length > 0
    ? _c("div", [
        _c(
          "div",
          {
          ...
          [
            ...
            _c("div", { staticClass: "flex flex-col space-y-2" }, [
              _c("table", {}, [
                ...
                _c(
                  "tbody",
                  { staticClass: "bg-white dark:bg-cool-gray-800" },
                  _vm._l(_vm.players, function(player, index) {
                    return _c(
                      "tr",
                      {
                        key: index,
                        class: {
                          "bg-gray-50 dark:bg-cool-gray-600 dark:bg-opacity-10":
                            index % 2 === 1
                        }
                      },
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "p-1 text-sm text-light-blue-400 font-extrabold"
                          },
                          [
                            player.position
                              ? _c(
                                  ...
                                  {
                                    staticClass:
                                      "border-2 rounded text-sm px-1 border-light-blue-300 bg-light-blue-50 dark:bg-cool-gray-800"
                                  },
                                  [
                                    _vm._v(
                                      "\n                " +
                          ...
                          _c("div", { staticClass: "flex items-center" }, [
                            _c(
                              "div",
                              {
                                ...
                                staticClass:
                                  "flex-shrink-0 h-6 w-6 focus:outline-none",
                                attrs: { content: player.country.name }
                              },
                              [
                                _c("img", {
                                  staticClass: "h-6 w-6",
                            ...
                            ? _c("div", { staticClass: "flex items-center" }, [
                                _c(
                                  "div",
                                  {
                                    ...
                                    staticClass:
                                      "flex-shrink-0 h-6 w-6 focus:outline-none",
                                    attrs: { content: player.rank.name }
                                  },
                                  [
                                    _c("img", {
                                      staticClass: "h-6 w-6",
                          ...
                          _c("div", { staticClass: "flex items-center" }, [
                            _c(
                              ...
                              [
                                _c("img", {
                                  staticClass: "h-6 w-6",
                                  attrs: { src: player.avatar_url, alt: "" }
                                })
                              ]
                            ),
                            _vm._v(" "),
                              ...
                              [
                                _c(
                                  "inertia-link",
                                  {
                                    ...
                                    staticClass:
                                      "text-sm text-gray-900 focus:outline-none cursor-pointer hover:underline",
                                    attrs: {
                                      as: "div",
                                      href: _vm.route(
                                        "player.show",
                                  ...
                                  [
                                    player.username
                                      ? _c(
                                          ...
                                          {
                                            staticClass:
                                              "text-gray-700 dark:text-gray-300 font-bold text-sm truncate"
                                          },
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "p-1 text-sm text-gray-700 hidden sm:table-cell"
                          },
                          [
                            player.rating != null
                              ? _c(
                                  ...
                                  [
                                    _c("icon", {
                                      ...
                                      staticClass: "w-6 h-6 focus:outline-none",
                                      attrs: {
                                        name: "rating-" + player.rating,
                                        content: player.rating
                                      }
                              ...
                              : _c(
                                  ...
                                  {
                                    staticClass:
                                      "text-gray-700 dark:text-gray-500 italic"
                                  },
                                  [_vm._v("none")]
                                )
                          ]
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "p-1 text-xs text-gray-700 dark:text-gray-300 hidden sm:table-cell"
                          },
                          [
                            _c(
                              "span",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "bg-gray-100 dark:bg-cool-gray-900 dark:bg-opacity-50 text-gray-700 dark:text-gray-300"
      },
      [
        _c("tr", [
          _c(
            ...
            {
              staticClass:
                "p-1 text-left text-xs font-bold text-center uppercase tracking-wider",
              attrs: { scope: "col" }
            },
            [_vm._v("\n              #\n            ")]
          ),
          ...
          _c(
            ...
            {
              staticClass:
                "p-1 text-left text-xs font-bold uppercase tracking-wider",
              attrs: { scope: "col" }
            },
            [_vm._v("\n              Flag\n            ")]
          ),
          ...
          _c(
            ...
            {
              staticClass:
                "p-1 text-left text-xs font-bold uppercase tracking-wider hidden sm:table-cell",
              attrs: { scope: "col" }
            },
            [_vm._v("\n              Rating\n            ")]
          ),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/VotingSitesBox.vue?vue&type=template&id=5970ddc2&":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/VotingSitesBox.vue?vue&type=template&id=5970ddc2& ***!
  \**********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.enabled && _vm.votingsites && _vm.votingsites.length > 0
    ? _c("div", [
        _c(
          "div",
          {
          ...
          [
            ...
            _c(
              ...
              {
                staticClass:
                  "rounded text-sm text-gray-600 dark:text-gray-400 text-center p-1"
              },
            ...
            _c(
              ...
              _vm._l(_vm.votingsites, function(votingsite, index) {
                return _c(
                  "div",
                  {
                    key: index,
                    staticClass:
                      "rounded flex justify-between items-center p-2 bg-gray-100 dark:bg-cool-gray-900"
                  },
                  [
                    _c(
                      "div",
                      {
                        directives: [{ name: "tippy", rawName: "v-tippy" }],
                        staticClass:
                          "text-gray-500 dark:text-gray-300 text-sm font-bold focus:outline-none",
                        attrs: { content: votingsite.url }
                      },
                      [
                        _vm._v(
                          "\n          " +
                            _vm._s(votingsite.name) +
                            "\n        "
                        )
                      ]
                    ),
                    ...
                    _c("div", [
                      _c(
                        ...
                        {
                          staticClass:
                            "rounded tracking-wider text-sm px-2 py-1 text-gray-500 dark:text-gray-300 bg-white dark:bg-cool-gray-800 shadow hover:shadow-md",
                          attrs: { target: "_blank", href: votingsite.url }
                        },
                        [_vm._v("Vote")]
                      )
                    ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/WelcomeBox.vue?vue&type=template&id=139392e5&":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Shared/WelcomeBox.vue?vue&type=template&id=139392e5& ***!
  \******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return _vm.htmlData
    ? _c("div", [
        _c(
          ...
          {
            staticClass:
              "bg-white dark:bg-cool-gray-800 rounded px-4 py-3 shadow"
          },
          [
            _c("div", {
              staticClass: "prose dark:prose-dark max-w-none text-center",
              domProps: { innerHTML: _vm._s(_vm.htmlData) }
            })
          ]
        )
      ])
