...
class ServerController extends Controller
{
    ...
    public function edit(Server $server)
    {
        ...
        $serverData = [
            ...
            "storage_server_host" => $decryptedStorageLoginData['host'],
            "storage_server_port" => $decryptedStorageLoginData['port'],
            "storage_server_username" => $decryptedStorageLoginData['username'],
            "storage_server_password" => $decryptedStorageLoginData['password'],
            "storage_server_root" => $decryptedStorageLoginData['root'],
            "name" => $server->name,
