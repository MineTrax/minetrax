...
class GeneralSettings extends Settings
{
    ...
    /**
     * Which page `/` renders: `dashboard` or `store`. Site-wide rather than a store setting,
     * because future modules should extend this allowlist rather than each adding a competing
     * "make me the homepage" flag of their own.
     */
    public string $homepage_route;
