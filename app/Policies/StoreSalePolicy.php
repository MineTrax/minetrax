...
class StoreSalePolicy
{
    ...
    {
        return $user?->can('read store_sales') ?? false;
    }
    ...
    {
        return $user?->can('create store_sales') ?? false;
    }
    ...
    {
        return $user?->can('update store_sales') ?? false;
    }
    ...
    {
        return $user?->can('delete store_sales') ?? false;
    }
}
